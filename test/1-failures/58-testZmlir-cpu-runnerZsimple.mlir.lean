...
"builtin.module"() ({
  "llvm.func"() ({
  }) {function_type = !llvm.func<f32 (f32)>, linkage = #llvm.linkage<e × ternal>, sym_name = "fabsf"} : () -> ()
  "llvm.func"() ({
  ...
  }) {function_type = !llvm.func<ptr<f32> ()>, linkage = #llvm.linkage<e × ternal>, sym_name = "allocation"} : () -> ()
  "llvm.func"() ({
  ^bb0(%arg0: !llvm.ptr<f32>):
    %0 = "llvm.bitcast"(%arg0) : (!llvm.ptr<f32>) -> !llvm.ptr<i8>
    "llvm.call"(%0) {callee = @free} : (!llvm.ptr<i8>) -> ()
    "llvm.return"() : () -> ()
  }) {function_type = !llvm.func<void (ptr<f32>)>, linkage = #llvm.linkage<e × ternal>, sym_name = "deallocation"} : () -> ()
  "llvm.func"() ({
    ...
    "llvm.return"(%5) : (f32) -> ()
  }) {function_type = !llvm.func<f32 ()>, linkage = #llvm.linkage<e × ternal>, sym_name = "foo"} : () -> ()
  "llvm.func"() ({
    %0 = "llvm.mlir.constant"() {value = 42 : i32} : () -> i32
    "llvm.return"(%0) : (i32) -> ()
  }) {function_type = !llvm.func<i32 ()>, linkage = #llvm.linkage<e × ternal>, sym_name = "int32_main"} : () -> ()
  "llvm.func"() ({
...
def main : IO Unit :=
    ...
    FS.writeFile "testZmlir-cpu-runnerZsimple.out.txt" str
