"builtin.module"() ({
  ...
  "func.func"() ({
    ...
    %6 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<2xindex>
  ...
  ^bb0(%arg0: memref<2x3xf32>, %arg1: memref<2xindex>):
    ...
    %1 = "memref.cast"(%0) : (memref<?x?xf32>) -> memref<* × f32>
  ...
  ^bb0(%arg0: memref<2x3xf32>, %arg1: memref<2xindex>):
    ...
    %2 = "memref.cast"(%1) : (memref<?x?xf32>) -> memref<* × f32>
  ...
  ^bb0(%arg0: memref<2x3xf32>, %arg1: memref<2xindex>):
    ...
    %1 = "memref.reshape"(%arg0, %0) : (memref<2x3xf32>, memref<?xindex>) -> memref<* × f32>
    "func.call"(%1) {callee = @print_memref_f32} : (memref<* × f32>) -> ()
    "func.return"() : () -> ()
  ...
  ^bb0(%arg0: memref<2x3xf32>, %arg1: memref<2xindex>):
    ...
    %2 = "memref.reshape"(%arg0, %1) : (memref<2x3xf32>, memref<?xindex>) -> memref<* × f32>
    "func.call"(%2) {callee = @print_memref_f32} : (memref<* × f32>) -> ()
    "func.return"() : () -> ()
