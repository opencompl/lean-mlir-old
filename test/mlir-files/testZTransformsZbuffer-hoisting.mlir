...
"builtin.module"() ({
  ...
  ^bb0(%arg0: i1, %arg1: memref<?xf32>, %arg2: memref<?xf32>, %arg3: index):
    "cf.cond_br"(%arg0, %arg3)[^bb1, ^bb2] {operand_segment_sizes = dense<[1, 0, 1]> : vector<3xi32>} : (i1, index) -> ()
  ^bb1:  // pred: ^bb0
    "cf.br"(%arg1)[^bb6] : (memref<?xf32>) -> ()
  ^bb2(%0: index):  // pred: ^bb0
    %1 = "memref.alloc"(%0) {operand_segment_sizes = dense<[1, 0]> : vector<2xi32>} : (index) -> memref<?xf32>
    "test.buffer_based"(%arg1, %1) : (memref<?xf32>, memref<?xf32>) -> ()
    "cf.cond_br"(%arg0)[^bb3, ^bb4] {operand_segment_sizes = dense<[1, 0, 0]> : vector<3xi32>} : (i1) -> ()
  ^bb3:  // pred: ^bb2
    "cf.br"(%1)[^bb5] : (memref<?xf32>) -> ()
  ^bb4:  // pred: ^bb2
    "cf.br"(%1)[^bb5] : (memref<?xf32>) -> ()
  ^bb5(%2: memref<?xf32>):  // 2 preds: ^bb3, ^bb4
    "cf.br"(%2)[^bb6] : (memref<?xf32>) -> ()
  ^bb6(%3: memref<?xf32>):  // 2 preds: ^bb1, ^bb5
    "cf.br"(%3)[^bb7] : (memref<?xf32>) -> ()
  ^bb7(%4: memref<?xf32>):  // pred: ^bb6
    "test.copy"(%4, %arg2) : (memref<?xf32>, memref<?xf32>) -> ()
    "func.return"() : () -> ()
  }) {function_type = (i1, memref<?xf32>, memref<?xf32>, index) -> (), sym_name = "condBranchDynamicTypeNested"} : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  ...
  ^bb3(%5: memref<2xf32>, %6: memref<2xf32>):  // 2 preds: ^bb1, ^bb2
    ...
    "test.buffer_based"(%7, %7) : (memref<2xf32>, memref<2xf32>) -> ()
...
"builtin.module"() ({
  ...
  ^bb3(%1: memref<2xf32>):  // 2 preds: ^bb1, ^bb2
    "test.copy"(%1, %arg2) : (memref<2xf32>, memref<2xf32>) -> ()
    "func.return"() : () -> ()
  }) {function_type = (i1, memref<2xf32>, memref<2xf32>) -> (), sym_name = "moving_invalid_dealloc_op_complex"} : () -> ()
}) : () -> ()
  ...
  ^bb0(%arg0: index, %arg1: index):
    ...
    %2 = "scf.if"(%0) ({
      %3 = "scf.if"(%0) ({
        ...
        %4 = "memref.alloc"(%arg0, %arg1) {operand_segment_sizes = dense<[2, 0]> : vector<2xi32>} : (index, index) -> memref<?x?xf32>
        "scf.yield"(%4) : (memref<?x?xf32>) -> ()
      }) : (i1) -> memref<?x?xf32>
      "scf.yield"(%3) : (memref<?x?xf32>) -> ()
    }, {
      %3 = "memref.alloc"(%arg1, %arg1) {operand_segment_sizes = dense<[2, 0]> : vector<2xi32>} : (index, index) -> memref<?x?xf32>
      "scf.yield"(%3) : (memref<?x?xf32>) -> ()
    }) : (i1) -> memref<?x?xf32>
    "func.return"(%2) : (memref<?x?xf32>) -> ()
...
"builtin.module"() ({
  ...
  ^bb0(%arg0: i32, %arg1: i1, %arg2: index):
    %0 = "scf.if"(%arg1) ({
      ...
      %4 = "memref.alloc"(%arg2, %3) {operand_segment_sizes = dense<[2, 0]> : vector<2xi32>} : (index, index) -> memref<?x?xf32>
      "scf.yield"(%4) : (memref<?x?xf32>) -> ()
    }, {
...
"builtin.module"() ({
  "func.func"() ({
  ^bb0(%arg0: index):
    %0 = "memref.alloc"(%arg0, %arg0) {operand_segment_sizes = dense<[2, 0]> : vector<2xi32>} : (index, index) -> memref<?x?xf32>
    %1 = "test.region_if"(%0) ({
...
"builtin.module"() ({
  ...
  ^bb3(%1: memref<2xf32>):  // 2 preds: ^bb1, ^bb2
    "test.copy"(%1, %arg2) : (memref<2xf32>, memref<2xf32>) -> ()
    "func.return"() : () -> ()
  }) {function_type = (i1, memref<2xf32>, memref<2xf32>) -> (), sym_name = "condBranchAlloca"} : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  ...
  ^bb5(%7: memref<2xf32>, %8: memref<2xf32>):  // 3 preds: ^bb1, ^bb3, ^bb4
    ...
    "test.copy"(%9, %arg2) : (memref<2xf32>, memref<2xf32>) -> ()
    "func.return"() : () -> ()
  }) {function_type = (i1, memref<2xf32>, memref<2xf32>) -> (), sym_name = "ifElseNestedAlloca"} : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  ...
  ^bb2:  // pred: ^bb0
    ...
    "test.region_buffer_based"(%arg1, %0) ({
    ^bb0(%arg3: f32, %arg4: f32):
      %2 = "memref.alloca"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<2xf32>
      "test.buffer_based"(%arg1, %2) : (memref<2xf32>, memref<2xf32>) -> ()
      %3 = "math.exp"(%arg3) : (f32) -> f32
      "test.region_yield"(%3) : (f32) -> ()
    }) : (memref<2xf32>, memref<2xf32>) -> ()
  ...
  ^bb3(%1: memref<2xf32>):  // 2 preds: ^bb1, ^bb2
    "test.copy"(%1, %arg2) : (memref<2xf32>, memref<2xf32>) -> ()
    "func.return"() : () -> ()
  }) {function_type = (i1, memref<2xf32>, memref<2xf32>) -> (), sym_name = "nestedRegionsAndCondBranchAlloca"} : () -> ()
}) : () -> ()
    ...
    ^bb0(%arg6: index, %arg7: memref<?xf32>):
      ...
      ^bb0(%arg8: index, %arg9: memref<?xf32>):
        ...
        ^bb0(%arg10: index, %arg11: memref<?xf32>):
          ...
          %5 = "scf.if"(%4) ({
            %6 = "memref.alloc"(%arg10) {operand_segment_sizes = dense<[1, 0]> : vector<2xi32>} : (index) -> memref<?xf32>
            "scf.yield"(%6) : (memref<?xf32>) -> ()
          }, {
            "scf.yield"(%arg11) : (memref<?xf32>) -> ()
          }) : (i1) -> memref<?xf32>
          "scf.yield"(%5) : (memref<?xf32>) -> ()
