"builtin.module"() ({
  ...
  "func.func"() ({
    ...
    %2 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<3x4x5xf32>
    %3 = "memref.cast"(%2) : (memref<3x4x5xf32>) -> memref<?x?x?xf32>
    "linalg.fill"(%0, %3) ({
    ^bb0(%arg0: f32, %arg1: f32):
      "linalg.yield"(%arg0) : (f32) -> ()
    }) {operand_segment_sizes = dense<1> : vector<2 × i32>} : (f32, memref<?x?x?xf32>) -> ()
    %4 = "arith.constant"() {value = 2 : index} : () -> index
    "memref.store"(%1, %3, %4, %4, %4) : (f32, memref<?x?x?xf32>, index, index, index) -> ()
    %5 = "memref.cast"(%3) : (memref<?x?x?xf32>) -> memref<* × f32>
  ...
  "func.func"() ({
    ...
    %3 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<1x1xvector<4x4xf32>>
