...
"builtin.module"() ({
  ...
  ^bb0(%arg0: memref<64x4xf32>, %arg1: memref<64x4xf32>):
    ...
    ^bb0(%arg2: index):
      "affine.for"() ({
      ^bb0(%arg3: index):
        "affine.store"(%1, %0, %arg2, %arg3) {map = #map0} : (f32, memref<64x4xf32>, index, index) -> ()
        "affine.yield"() : () -> ()
    ...
    ^bb0(%arg2: index):
      ...
      ^bb0(%arg3: index):
        "affine.for"() ({
        ^bb0(%arg4: index):
          %2 = "affine.load"(%arg1, %arg3, %arg4, %arg2) {map = #map4} : (memref<64x4xf32>, index, index, index) -> f32
          "op0"(%2) : (f32) -> ()
          "affine.yield"() : () -> ()
        ...
        ^bb0(%arg4: index):
          "affine.for"() ({
          ^bb0(%arg5: index):
            %2 = "affine.load"(%arg0, %arg4, %arg5, %arg3) {map = #map4} : (memref<64x4xf32>, index, index, index) -> f32
            "op1"(%2) : (f32) -> ()
            "affine.yield"() : () -> ()
          }) {lower_bound = #map1, step = 1 : index, upper_bound = #map5} : () -> ()
          "affine.for"() ({
          ^bb0(%arg5: index):
            %2 = "op2"() : () -> f32
            %3 = "affine.load"(%0, %arg4, %arg5, %arg2) {map = #map6} : (memref<64x4xf32>, index, index, index) -> f32
            %4 = "arith.addf"(%3, %2) : (f32, f32) -> f32
            "affine.store"(%4, %0, %arg4, %arg5, %arg2) {map = #map6} : (f32, memref<64x4xf32>, index, index, index) -> ()
            "affine.yield"() : () -> ()
          }) {lower_bound = #map1, step = 1 : index, upper_bound = #map5} : () -> ()
          "affine.yield"() : () -> ()
        }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
    ...
    "func.return"() : () -> ()
  }) {function_type = (memref<64x4xf32>, memref<64x4xf32>) -> (), sym_name = "should_fuse_at_depth_above_loop_carried_dependence"} : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() ({
    ...
    ^bb0(%arg0: index):
      "affine.for"() ({
      ^bb0(%arg1: index):
        "affine.store"(%1, %0, %arg0, %arg1) {map = #map0} : (f32, memref<6x8xf32>, index, index) -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map3} : () -> ()
    ...
    ^bb0(%arg0: index):
      ...
      ^bb0(%arg1: index):
        ...
        ^bb0(%arg2: index):
          "affine.for"() ({
          ^bb0(%arg3: index):
            %2 = "affine.load"(%0, %arg1, %arg3) {map = #map0} : (memref<6x8xf32>, index, index) -> f32
            %3 = "arith.addf"(%2, %2) : (f32, f32) -> f32
            "affine.store"(%3, %0, %arg1, %arg3) {map = #map0} : (f32, memref<6x8xf32>, index, index) -> ()
            "affine.yield"() : () -> ()
          }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
          "affine.yield"() : () -> ()
...
"builtin.module"() ({
  "func.func"() ({
  ^bb0(%arg0: memref<128x8xf32>, %arg1: memref<32x8xf32>, %arg2: f32):
    "affine.for"() ({
    ^bb0(%arg3: index):
      "affine.for"() ({
      ^bb0(%arg4: index):
        "affine.store"(%arg2, %arg1, %arg3, %arg4) {map = #map0} : (f32, memref<32x8xf32>, index, index) -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map3} : () -> ()
    ...
    ^bb0(%arg3: index):
      ...
      ^bb0(%arg4: index):
        ...
        ^bb0(%arg5: index):
          "affine.for"() ({
          ^bb0(%arg6: index):
            %0 = "affine.load"(%arg0, %arg5, %arg6, %arg4) {map = #map4} : (memref<128x8xf32>, index, index, index) -> f32
            %1 = "foo"(%0) : (f32) -> f32
            "affine.yield"() : () -> ()
          }) {lower_bound = #map1, step = 1 : index, upper_bound = #map5} : () -> ()
          "affine.for"() ({
          ^bb0(%arg6: index):
            %0 = "affine.load"(%arg1, %arg3, %arg6, %arg4) {map = #map4} : (memref<32x8xf32>, index, index, index) -> f32
            %1 = "arith.addf"(%0, %0) : (f32, f32) -> f32
            "affine.store"(%1, %arg1, %arg3, %arg6, %arg4) {map = #map4} : (f32, memref<32x8xf32>, index, index, index) -> ()
            "affine.yield"() : () -> ()
          }) {lower_bound = #map1, step = 1 : index, upper_bound = #map5} : () -> ()
          "affine.yield"() : () -> ()
        }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
    ...
    "func.return"(%arg1) : (memref<32x8xf32>) -> ()
  }) {function_type = (memref<128x8xf32>, memref<32x8xf32>, f32) -> memref<32x8xf32>, sym_name = "slice_tile"} : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  ...
  ^bb0(%arg0: memref<10x10xf32>, %arg1: memref<10x10xf32>):
    ...
    ^bb0(%arg2: index):
      "affine.for"() ({
      ^bb0(%arg3: index):
        "affine.store"(%3, %0, %arg2, %arg3) {map = #map0} : (f32, memref<10x10xf32>, index, index) -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
    ...
    ^bb0(%arg2: index):
      "affine.for"() ({
      ^bb0(%arg3: index):
        "affine.store"(%1, %arg0, %arg2, %arg3) {map = #map0} : (f32, memref<10x10xf32>, index, index) -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map3} : () -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map3} : () -> ()
    ...
    ^bb0(%arg2: index):
      "affine.for"() ({
      ^bb0(%arg3: index):
        %4 = "affine.load"(%0, %arg2, %arg3) {map = #map0} : (memref<10x10xf32>, index, index) -> f32
        %5 = "affine.load"(%arg0, %arg2, %arg3) {map = #map0} : (memref<10x10xf32>, index, index) -> f32
        %6 = "arith.mulf"(%4, %5) : (f32, f32) -> f32
        "affine.store"(%6, %arg0, %arg2, %arg3) {map = #map0} : (f32, memref<10x10xf32>, index, index) -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map3} : () -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map3} : () -> ()
    ...
    ^bb0(%arg2: index):
      "affine.for"() ({
      ^bb0(%arg3: index):
        "affine.store"(%2, %arg1, %arg2, %arg3) {map = #map0} : (f32, memref<10x10xf32>, index, index) -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map3} : () -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map3} : () -> ()
    ...
    ^bb0(%arg2: index):
      ...
      ^bb0(%arg3: index):
        %4 = "affine.load"(%0, %arg2, %arg3) {map = #map0} : (memref<10x10xf32>, index, index) -> f32
        %5 = "affine.load"(%arg1, %arg2, %arg3) {map = #map0} : (memref<10x10xf32>, index, index) -> f32
        %6 = "arith.addf"(%4, %5) : (f32, f32) -> f32
        "affine.store"(%6, %arg1, %arg2, %arg3) {map = #map0} : (f32, memref<10x10xf32>, index, index) -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map3} : () -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map3} : () -> ()
    "func.return"() : () -> ()
  }) {function_type = (memref<10x10xf32>, memref<10x10xf32>) -> (), sym_name = "should_fuse_init_loops_siblings_then_shared_producer"} : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() ({
    ...
    ^bb0(%arg0: index):
      "affine.for"() ({
      ^bb0(%arg1: index):
        "affine.store"(%5, %0, %arg0, %arg1) {map = #map0} : (f32, memref<10x10xf32>, index, index) -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
...
"builtin.module"() ({
  "func.func"() ({
    ...
    ^bb0(%arg0: index):
      ...
      ^bb0(%arg1: index):
        %1 = "op1"() : () -> f32
        "affine.store"(%1, %0, %arg0, %arg1) {map = #map0} : (f32, memref<100x16xf32>, index, index) -> ()
        "affine.yield"() : () -> ()
    ...
    ^bb0(%arg0: index):
      "affine.for"() ({
      ^bb0(%arg1: index):
        %1 = "affine.load"(%0, %arg0, %arg1) {map = #map0} : (memref<100x16xf32>, index, index) -> f32
        "op2"(%1) : (f32) -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
      "affine.yield"() : () -> ()
    ...
    ^bb0(%arg3: index):
      ...
      ^bb0(%arg4: index):
        ...
        ^bb0(%arg5: index):
          ...
          "affine.store"(%1, %0, %2, %arg4) {map = #map1} : (f32, memref<144x4xf32>, index, index) -> ()
          "affine.yield"() : () -> ()
        }) {lower_bound = #map2, step = 1 : index, upper_bound = #map3} : () -> ()
        "affine.yield"() : () -> ()
      ...
      ^bb0(%arg4: index):
        ...
        ^bb0(%arg5: index):
          ...
          ^bb0(%arg6: index):
            ...
            %3 = "affine.load"(%0, %2, %arg5) {map = #map1} : (memref<144x4xf32>, index, index) -> f32
            "affine.yield"() : () -> ()
          }) {lower_bound = #map2, step = 1 : index, upper_bound = #map3} : () -> ()
          "affine.yield"() : () -> ()
        }) {lower_bound = #map2, step = 1 : index, upper_bound = #map4} : () -> ()
  ...
  ^bb0(%arg0: f32):
    ...
    ^bb0(%arg1: index):
      ...
      ^bb0(%arg2: index):
        ...
        "affine.store"(%9, %2, %arg1, %arg2) {map = #map6} : (f32, memref<64x9xf32>, index, index) -> ()
        "affine.yield"() : () -> ()
    ...
    ^bb0(%arg1: index):
      ...
      ^bb0(%arg2: index):
        ...
        ^bb0(%arg3: index):
          ...
          %5 = "affine.load"(%2, %4, %arg1) {map = #map6} : (memref<64x9xf32>, index, index) -> f32
          "affine.yield"() : () -> ()
        }) {lower_bound = #map7, step = 1 : index, upper_bound = #map11} : () -> ()
        "affine.for"() ({
        ^bb0(%arg3: index):
          %4 = "affine.apply"(%arg1, %arg3) {map = #map10} : (index, index) -> index
          "affine.store"(%arg0, %3, %4, %arg2) {map = #map6} : (f32, memref<144x4xf32>, index, index) -> ()
          "affine.yield"() : () -> ()
        }) {lower_bound = #map7, step = 1 : index, upper_bound = #map11} : () -> ()
        "affine.yield"() : () -> ()
      ...
      ^bb0(%arg2: index):
        ...
        ^bb0(%arg3: index):
          ...
          ^bb0(%arg4: index):
            ...
            %5 = "affine.load"(%2, %4, %arg2) {map = #map6} : (memref<64x9xf32>, index, index) -> f32
            "affine.yield"() : () -> ()
          }) {lower_bound = #map7, step = 1 : index, upper_bound = #map11} : () -> ()
          "affine.yield"() : () -> ()
        }) {lower_bound = #map7, step = 1 : index, upper_bound = #map12} : () -> ()
...
"builtin.module"() ({
  "func.func"() ({
  ^bb0(%arg0: memref<1024x1024xf32>, %arg1: memref<1024x1024xf32>, %arg2: memref<1024x1024xf32>, %arg3: memref<1024x1024xf32>):
    "affine.for"() ({
    ^bb0(%arg4: index):
      "affine.for"() ({
      ^bb0(%arg5: index):
        %0 = "affine.load"(%arg3, %arg4, %arg5) {map = #map0} : (memref<1024x1024xf32>, index, index) -> f32
        %1 = "affine.load"(%arg2, %arg4, %arg5) {map = #map0} : (memref<1024x1024xf32>, index, index) -> f32
        %2 = "arith.addf"(%1, %0) : (f32, f32) -> f32
        "affine.store"(%2, %arg2, %arg4, %arg5) {map = #map0} : (f32, memref<1024x1024xf32>, index, index) -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
    ...
    ^bb0(%arg4: index):
      ...
      ^bb0(%arg5: index):
        "affine.for"() ({
        ^bb0(%arg6: index):
          %0 = "affine.load"(%arg1, %arg6, %arg5) {map = #map0} : (memref<1024x1024xf32>, index, index) -> f32
          %1 = "affine.load"(%arg0, %arg4, %arg6) {map = #map0} : (memref<1024x1024xf32>, index, index) -> f32
          %2 = "arith.mulf"(%1, %0) : (f32, f32) -> f32
          %3 = "affine.load"(%arg2, %arg4, %arg5) {map = #map0} : (memref<1024x1024xf32>, index, index) -> f32
          %4 = "arith.addf"(%3, %2) : (f32, f32) -> f32
          "affine.store"(%4, %arg2, %arg4, %arg5) {map = #map0} : (f32, memref<1024x1024xf32>, index, index) -> ()
          "affine.yield"() : () -> ()
        }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
    ...
    "func.return"() : () -> ()
  }) {function_type = (memref<1024x1024xf32>, memref<1024x1024xf32>, memref<1024x1024xf32>, memref<1024x1024xf32>) -> (), sym_name = "affine_add_mm_fused"} : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() ({
  ^bb0(%arg0: memref<1024x1024xf32>, %arg1: memref<1024x1024xf32>, %arg2: memref<1024x1024xf32>, %arg3: memref<1024x1024xf32>, %arg4: memref<1024x1024xf32>):
    %0 = "arith.constant"() {value = 0.000000e+00 : f32} : () -> f32
    "affine.for"() ({
    ^bb0(%arg5: index):
      "affine.for"() ({
      ^bb0(%arg6: index):
        "affine.store"(%0, %arg2, %arg5, %arg6) {map = #map0} : (f32, memref<1024x1024xf32>, index, index) -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
    ...
    ^bb0(%arg5: index):
      "affine.for"() ({
      ^bb0(%arg6: index):
        "affine.store"(%0, %arg4, %arg5, %arg6) {map = #map0} : (f32, memref<1024x1024xf32>, index, index) -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
    ...
    ^bb0(%arg5: index):
      ...
      ^bb0(%arg6: index):
        "affine.for"() ({
        ^bb0(%arg7: index):
          %1 = "affine.load"(%arg1, %arg7, %arg6) {map = #map0} : (memref<1024x1024xf32>, index, index) -> f32
          %2 = "affine.load"(%arg0, %arg5, %arg7) {map = #map0} : (memref<1024x1024xf32>, index, index) -> f32
          %3 = "arith.mulf"(%2, %1) : (f32, f32) -> f32
          %4 = "affine.load"(%arg2, %arg5, %arg6) {map = #map0} : (memref<1024x1024xf32>, index, index) -> f32
          %5 = "arith.addf"(%4, %3) : (f32, f32) -> f32
          "affine.store"(%5, %arg2, %arg5, %arg6) {map = #map0} : (f32, memref<1024x1024xf32>, index, index) -> ()
          "affine.yield"() : () -> ()
        }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
    ...
    ^bb0(%arg5: index):
      ...
      ^bb0(%arg6: index):
        ...
        ^bb0(%arg7: index):
          ...
          %2 = "affine.load"(%arg0, %arg5, %arg7) {map = #map0} : (memref<1024x1024xf32>, index, index) -> f32
          %3 = "arith.mulf"(%2, %1) : (f32, f32) -> f32
          %4 = "affine.load"(%arg4, %arg5, %arg6) {map = #map0} : (memref<1024x1024xf32>, index, index) -> f32
          %5 = "arith.addf"(%4, %3) : (f32, f32) -> f32
          "affine.store"(%5, %arg4, %arg5, %arg6) {map = #map0} : (f32, memref<1024x1024xf32>, index, index) -> ()
          "affine.yield"() : () -> ()
        }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
    ...
    "func.return"() : () -> ()
  }) {function_type = (memref<1024x1024xf32>, memref<1024x1024xf32>, memref<1024x1024xf32>, memref<1024x1024xf32>, memref<1024x1024xf32>) -> (), sym_name = "affine_2mm_fused"} : () -> ()
}) : () -> ()
  ...
  ^bb0(%arg0: memref<1024x1024xf32>, %arg1: memref<1024x1024xf32>, %arg2: memref<1024x1024xf32>, %arg3: memref<1024x1024xf32>, %arg4: memref<1024x1024xf32>):
    ...
    ^bb0(%arg5: index):
      ...
      ^bb0(%arg6: index):
        "affine.for"() ({
        ^bb0(%arg7: index):
          %0 = "affine.load"(%arg1, %arg7, %arg6) {map = #map0} : (memref<1024x1024xf32>, index, index) -> f32
          %1 = "affine.load"(%arg0, %arg5, %arg7) {map = #map0} : (memref<1024x1024xf32>, index, index) -> f32
          %2 = "arith.mulf"(%1, %0) : (f32, f32) -> f32
          %3 = "affine.load"(%arg2, %arg5, %arg6) {map = #map0} : (memref<1024x1024xf32>, index, index) -> f32
          %4 = "arith.addf"(%3, %2) : (f32, f32) -> f32
          "affine.store"(%4, %arg2, %arg5, %arg6) {map = #map0} : (f32, memref<1024x1024xf32>, index, index) -> ()
          "affine.yield"() : () -> ()
        }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
    ...
    ^bb0(%arg5: index):
      ...
      ^bb0(%arg6: index):
        "affine.for"() ({
        ^bb0(%arg7: index):
          %0 = "affine.load"(%arg3, %arg7, %arg6) {map = #map0} : (memref<1024x1024xf32>, index, index) -> f32
          %1 = "affine.load"(%arg2, %arg5, %arg7) {map = #map0} : (memref<1024x1024xf32>, index, index) -> f32
          %2 = "arith.mulf"(%1, %0) : (f32, f32) -> f32
          %3 = "affine.load"(%arg4, %arg5, %arg6) {map = #map0} : (memref<1024x1024xf32>, index, index) -> f32
          %4 = "arith.addf"(%3, %2) : (f32, f32) -> f32
          "affine.store"(%4, %arg4, %arg5, %arg6) {map = #map0} : (f32, memref<1024x1024xf32>, index, index) -> ()
          "affine.yield"() : () -> ()
        }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
    ...
    "func.return"() : () -> ()
  }) {function_type = (memref<1024x1024xf32>, memref<1024x1024xf32>, memref<1024x1024xf32>, memref<1024x1024xf32>, memref<1024x1024xf32>) -> (), sym_name = "affine_2_dependent_mm_fused"} : () -> ()
}) : () -> ()
