"builtin.module"() ({
  "func.func"() ({
    %0 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<10x3xf32>
    ...
    }) {operand_segment_sizes = dense<1> : vector<2 × i32>} : (f32, memref<?x?xf32>) -> ()
    %5 = "memref.cast"(%0) : (memref<10x3xf32>) -> memref<* × f32>
    "func.call"(%5) {callee = @print_memref_f32} : (memref<* × f32>) -> ()
    %6 = "memref.cast"(%5) : (memref<* × f32>) -> memref<?x?xf32>
    "linalg.fill"(%2, %6) ({
    ^bb0(%arg0: f32, %arg1: f32):
      "linalg.yield"(%arg0) : (f32) -> ()
    }) {operand_segment_sizes = dense<1> : vector<2 × i32>} : (f32, memref<?x?xf32>) -> ()
    %7 = "memref.cast"(%6) : (memref<?x?xf32>) -> memref<* × f32>
    "func.call"(%7) {callee = @print_memref_f32} : (memref<* × f32>) -> ()
    %8 = "memref.cast"(%6) : (memref<?x?xf32>) -> memref<* × f32>
    %9 = "memref.cast"(%8) : (memref<* × f32>) -> memref<?x?xf32>
    "linalg.fill"(%1, %9) ({
    ^bb0(%arg0: f32, %arg1: f32):
      "linalg.yield"(%arg0) : (f32) -> ()
    }) {operand_segment_sizes = dense<1> : vector<2 × i32>} : (f32, memref<?x?xf32>) -> ()
    %10 = "memref.cast"(%6) : (memref<?x?xf32>) -> memref<* × f32>
  ...
  "func.func"() ({
    %0 = "memref.alloca"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<4x3xf32>
    %1 = "arith.constant"() {value = 1.000000e+00 : f32} : () -> f32
    "linalg.fill"(%1, %0) ({
    ^bb0(%arg0: f32, %arg1: f32):
      "linalg.yield"(%arg0) : (f32) -> ()
    }) {operand_segment_sizes = dense<1> : vector<2 × i32>} : (f32, memref<4x3xf32>) -> ()
    %2:2 = "func.call"(%0) {callee = @return_two_var_memref} : (memref<4x3xf32>) -> (memref<* × f32>, memref<* × f32>)
  ...
  ^bb0(%arg0: memref<4x3xf32>):
    %0 = "memref.cast"(%arg0) : (memref<4x3xf32>) -> memref<* × f32>
    "func.return"(%0, %0) : (memref<* × f32>, memref<* × f32>) -> ()
  }) {function_type = (memref<4x3xf32>) -> (memref<* × f32>, memref<* × f32>), sym_name = "return_two_var_memref"} : () -> ()
  "func.func"() ({
    %0 = "memref.alloca"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<4x3xf32>
    %1 = "arith.constant"() {value = 1.000000e+00 : f32} : () -> f32
    "linalg.fill"(%1, %0) ({
    ...
    %2 = "func.call"(%0) {callee = @return_var_memref} : (memref<4x3xf32>) -> memref<* × f32>
  ...
  }) {function_type = (memref<4x3xf32>) -> memref<* × f32>, sym_name = "return_var_memref"} : () -> ()
  "func.func"() ({
  ...
  "func.func"() ({
    %0 = "memref.alloca"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<4x3xf32>
    %1 = "memref.cast"(%0) : (memref<4x3xf32>) -> memref<* × f32>
