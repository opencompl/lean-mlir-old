...
"builtin.module"() ({
  ...
  "func.func"() ({
    ...
    "func.return"(%2) : (i32) -> ()
  }) {function_type = () -> i32, sym_name = "remove_direct_duplicated_read_op"} : () -> ()
  "func.func"() ({
    ...
    "func.return"(%6) : (i64) -> ()
  }) {function_type = () -> i64, sym_name = "remove_multiple_duplicated_read_op"} : () -> ()
  "func.func"() ({
    %0 = "test.op_with_memread"() : () -> i32
    ...
    %2 = "arith.addi"(%0, %1) : (i32, i32) -> i32
    "func.return"(%2) : (i32) -> ()
  }) {function_type = () -> i32, sym_name = "dont_remove_duplicated_read_op_with_sideeffecting"} : () -> ()
}) : () -> ()
