...
"builtin.module"() ({
  ...
  ^bb0(%arg0: memref<1024x1024xf32>, %arg1: memref<16x64x1024xf32>, %arg2: memref<1024x1024xf32>):
    %0 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<1024x1024xf32>
    "affine.for"() ({
    ^bb0(%arg3: index):
      "affine.for"() ({
      ^bb0(%arg4: index):
...
"builtin.module"() ({
  ...
  ^bb0(%arg0: memref<10x20xf32>, %arg1: memref<10x20xf32>, %arg2: memref<10x20xf32>):
    ...
    ^bb0(%arg3: index):
      "affine.for"() ({
      ^bb0(%arg4: index):
        %0 = "affine.vector_load"(%arg0, %arg3, %arg4) {map = #map0} : (memref<10x20xf32>, index, index) -> vector<4 × f32>
        "affine.vector_store"(%0, %arg1, %arg3, %arg4) {map = #map0} : (vector<4 × f32>, memref<10x20xf32>, index, index) -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map3} : () -> ()
    ...
    ^bb0(%arg3: index):
      "affine.for"() ({
      ^bb0(%arg4: index):
        %0 = "affine.vector_load"(%arg1, %arg3, %arg4) {map = #map0} : (memref<10x20xf32>, index, index) -> vector<4 × f32>
        "affine.vector_store"(%0, %arg2, %arg3, %arg4) {map = #map0} : (vector<4 × f32>, memref<10x20xf32>, index, index) -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map3} : () -> ()
...
"builtin.module"() ({
  "func.func"() ({
  ^bb0(%arg0: memref<128 × f32>, %arg1: memref<20x512xf32>):
    ...
    "func.return"() : () -> ()
  }) {function_type = (memref<128 × f32>, memref<20x512xf32>) -> (), sym_name = "fuse_minor_affine_map"} : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  ...
  ^bb0(%arg0: memref<20x10xf32, 1>, %arg1: memref<20x10xf32, 1>, %arg2: memref<20x10xf32, 1>, %arg3: memref<20x10xf32, 1>, %arg4: memref<20x10xf32, 1>, %arg5: memref<f32, 1>, %arg6: memref<f32, 1>, %arg7: memref<f32, 1>, %arg8: memref<f32, 1>, %arg9: memref<20x10xf32, 1>, %arg10: memref<20x10xf32, 1>, %arg11: memref<20x10xf32, 1>, %arg12: memref<20x10xf32, 1>):
    ...
    %2 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<20x10xf32, 1>
    "affine.for"() ({
    ^bb0(%arg13: index):
      "affine.for"() ({
      ^bb0(%arg14: index):
    ...
    %3 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<20x10xf32, 1>
    "affine.for"() ({
    ^bb0(%arg13: index):
      "affine.for"() ({
      ^bb0(%arg14: index):
    ...
    %8 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<20x10xf32, 1>
    "affine.for"() ({
    ^bb0(%arg13: index):
      "affine.for"() ({
      ^bb0(%arg14: index):
    ...
    %9 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<20x10xf32, 1>
    "affine.for"() ({
    ^bb0(%arg13: index):
      "affine.for"() ({
      ^bb0(%arg14: index):
    ...
    %10 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<20x10xf32, 1>
    "affine.for"() ({
    ^bb0(%arg13: index):
      "affine.for"() ({
      ^bb0(%arg14: index):
    ...
    %11 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<20x10xf32, 1>
    "affine.for"() ({
    ^bb0(%arg13: index):
      "affine.for"() ({
      ^bb0(%arg14: index):
    ...
    %12 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<20x10xf32, 1>
    "affine.for"() ({
    ^bb0(%arg13: index):
      "affine.for"() ({
      ^bb0(%arg14: index):
    ...
    %13 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<20x10xf32, 1>
    "affine.for"() ({
    ^bb0(%arg13: index):
      "affine.for"() ({
      ^bb0(%arg14: index):
    ...
    %14 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<20x10xf32, 1>
    "affine.for"() ({
    ^bb0(%arg13: index):
      "affine.for"() ({
      ^bb0(%arg14: index):
    ...
    %15 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<20x10xf32, 1>
    "affine.for"() ({
    ^bb0(%arg13: index):
      "affine.for"() ({
      ^bb0(%arg14: index):
    ...
    %16 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<20x10xf32, 1>
    "affine.for"() ({
    ^bb0(%arg13: index):
      "affine.for"() ({
      ^bb0(%arg14: index):
    ...
    %17 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<20x10xf32, 1>
    "affine.for"() ({
    ^bb0(%arg13: index):
      "affine.for"() ({
      ^bb0(%arg14: index):
    ...
    %18 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<20x10xf32, 1>
    "affine.for"() ({
    ^bb0(%arg13: index):
      "affine.for"() ({
      ^bb0(%arg14: index):
    ...
    %19 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<20x10xf32, 1>
    "affine.for"() ({
    ^bb0(%arg13: index):
      "affine.for"() ({
      ^bb0(%arg14: index):
    ...
    %20 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<20x10xf32, 1>
    "affine.for"() ({
    ^bb0(%arg13: index):
      "affine.for"() ({
      ^bb0(%arg14: index):
    ...
    %21 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<20x10xf32, 1>
    "affine.for"() ({
    ^bb0(%arg13: index):
      "affine.for"() ({
      ^bb0(%arg14: index):
