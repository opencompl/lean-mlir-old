...
"builtin.module"() ({
  ...
  }) {function_type = (tensor<4x5xi32>) -> tensor<4x5xi32>, sym_name = "test_subi_zero_tensor"} : () -> ()
  "func.func"() ({
  ...
  ^bb0(%arg0: tensor<8x4xf32>):
    ...
    %1 = "tensor.dim"(%arg0, %0) : (tensor<8x4xf32>, index) -> index
    "func.return"() : () -> ()
  }) {function_type = (tensor<8x4xf32>) -> (), sym_name = "trivial_dce"} : () -> ()
  "func.func"() ({
  ^bb0(%arg0: index):
  ...
  ^bb0(%arg0: tensor<4x5xi32>):
    ...
    %1 = "arith.addi"(%arg0, %0) : (tensor<4x5xi32>, tensor<4x5xi32>) -> tensor<4x5xi32>
    "func.return"(%1) : (tensor<4x5xi32>) -> ()
  }) {function_type = (tensor<4x5xi32>) -> tensor<4x5xi32>, sym_name = "addi_zero_tensor"} : () -> ()
  "func.func"() ({
  ^bb0(%arg0: i32):
    %0 = "arith.constant"() {value = 0 : i32} : () -> i32
  ...
  ^bb0(%arg0: tensor<4x5xi32>):
    %0 = "arith.constant"() {value = dense<0> : tensor<4x5xi32>} : () -> tensor<4x5xi32>
    %1 = "arith.muli"(%arg0, %0) : (tensor<4x5xi32>, tensor<4x5xi32>) -> tensor<4x5xi32>
    "func.return"(%1) : (tensor<4x5xi32>) -> ()
  }) {function_type = (tensor<4x5xi32>) -> tensor<4x5xi32>, sym_name = "muli_zero_tensor"} : () -> ()
  "func.func"() ({
  ^bb0(%arg0: i32):
  ...
  ^bb0(%arg0: tensor<4x5xi32>):
    ...
    %1 = "arith.muli"(%arg0, %0) : (tensor<4x5xi32>, tensor<4x5xi32>) -> tensor<4x5xi32>
    "func.return"(%1) : (tensor<4x5xi32>) -> ()
  }) {function_type = (tensor<4x5xi32>) -> tensor<4x5xi32>, sym_name = "muli_one_tensor"} : () -> ()
  "func.func"() ({
  ^bb0(%arg0: i32):
  ...
  ^bb0(%arg0: tensor<4x5xi32>):
    ...
    "func.return"(%0) : (tensor<4x5xi32>) -> ()
  }) {function_type = (tensor<4x5xi32>) -> tensor<4x5xi32>, sym_name = "and_self_tensor"} : () -> ()
  "func.func"() ({
  ^bb0(%arg0: i32):
    %0 = "arith.constant"() {value = 0 : i32} : () -> i32
  ...
  ^bb0(%arg0: tensor<4x5xi32>):
    %0 = "arith.constant"() {value = dense<0> : tensor<4x5xi32>} : () -> tensor<4x5xi32>
    %1 = "arith.andi"(%arg0, %0) : (tensor<4x5xi32>, tensor<4x5xi32>) -> tensor<4x5xi32>
    "func.return"(%1) : (tensor<4x5xi32>) -> ()
  }) {function_type = (tensor<4x5xi32>) -> tensor<4x5xi32>, sym_name = "and_zero_tensor"} : () -> ()
  "func.func"() ({
  ^bb0(%arg0: i32):
  ...
  ^bb0(%arg0: tensor<4x5xi32>):
    ...
    "func.return"(%0) : (tensor<4x5xi32>) -> ()
  }) {function_type = (tensor<4x5xi32>) -> tensor<4x5xi32>, sym_name = "or_self_tensor"} : () -> ()
  "func.func"() ({
  ^bb0(%arg0: i32):
    %0 = "arith.constant"() {value = 0 : i32} : () -> i32
  ...
  ^bb0(%arg0: tensor<4x5xi32>):
    %0 = "arith.constant"() {value = dense<0> : tensor<4x5xi32>} : () -> tensor<4x5xi32>
    %1 = "arith.ori"(%arg0, %0) : (tensor<4x5xi32>, tensor<4x5xi32>) -> tensor<4x5xi32>
    "func.return"(%1) : (tensor<4x5xi32>) -> ()
  }) {function_type = (tensor<4x5xi32>) -> tensor<4x5xi32>, sym_name = "or_zero_tensor"} : () -> ()
  "func.func"() ({
  ^bb0(%arg0: i1, %arg1: i4):
  ...
  ^bb0(%arg0: memref<42x42xf64>):
    ...
    %1 = "memref.cast"(%0) : (memref<?x42xf64>) -> memref<?x?xf64>
    "test.user"(%1) : (memref<?x?xf64>) -> ()
    "func.return"() : () -> ()
  }) {function_type = (memref<42x42xf64>) -> (), sym_name = "fold_memref_cast_in_memref_cast"} : () -> ()
  "func.func"() ({
  ^bb0(%arg0: memref<42x42xf64>):
    %0 = "memref.cast"(%arg0) : (memref<42x42xf64>) -> memref<?x42xf64>
    %1 = "memref.cast"(%0) : (memref<?x42xf64>) -> memref<42x42xf64>
    "test.user"(%1) : (memref<42x42xf64>) -> ()
    "func.return"() : () -> ()
  ...
  ^bb0(%arg0: index, %arg1: index):
    ...
    ^bb0(%arg2: index):
      "affine.for"() ({
      ^bb0(%arg3: index):
        %9 = "memref.load"(%4, %arg2, %arg3) : (memref<?x?xf32>, index, index) -> f32
...
"builtin.module"() ({
  ...
  ^bb0(%arg0: tensor<4x5xi32>):
    %0 = "arith.constant"() {value = dense<1> : tensor<4x5xi32>} : () -> tensor<4x5xi32>
    %1 = "arith.divsi"(%arg0, %0) : (tensor<4x5xi32>, tensor<4x5xi32>) -> tensor<4x5xi32>
    "func.return"(%1) : (tensor<4x5xi32>) -> ()
  }) {function_type = (tensor<4x5xi32>) -> tensor<4x5xi32>, sym_name = "tensor_divi_signed_by_one"} : () -> ()
  "func.func"() ({
  ^bb0(%arg0: tensor<4x5xi32>):
    %0 = "arith.constant"() {value = dense<1> : tensor<4x5xi32>} : () -> tensor<4x5xi32>
    %1 = "arith.divui"(%arg0, %0) : (tensor<4x5xi32>, tensor<4x5xi32>) -> tensor<4x5xi32>
    "func.return"(%1) : (tensor<4x5xi32>) -> ()
  }) {function_type = (tensor<4x5xi32>) -> tensor<4x5xi32>, sym_name = "tensor_divi_unsigned_by_one"} : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  ...
  ^bb0(%arg0: tensor<4x5xi32>):
    %0 = "arith.constant"() {value = dense<1> : tensor<4x5xi32>} : () -> tensor<4x5xi32>
    %1 = "arith.floordivsi"(%arg0, %0) : (tensor<4x5xi32>, tensor<4x5xi32>) -> tensor<4x5xi32>
    "func.return"(%1) : (tensor<4x5xi32>) -> ()
  }) {function_type = (tensor<4x5xi32>) -> tensor<4x5xi32>, sym_name = "tensor_arith.floordivsi_by_one"} : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  ...
  ^bb0(%arg0: tensor<4x5xi32>):
    ...
    "func.return"(%1) : (tensor<4x5xi32>) -> ()
  }) {function_type = (tensor<4x5xi32>) -> tensor<4x5xi32>, sym_name = "tensor_arith.ceildivsi_by_one"} : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  ...
  ^bb0(%arg0: tensor<4x5xi32>):
    ...
    "func.return"(%1) : (tensor<4x5xi32>) -> ()
  }) {function_type = (tensor<4x5xi32>) -> tensor<4x5xi32>, sym_name = "tensor_arith.ceildivui_by_one"} : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() ({
  ^bb0(%arg0: tensor<8x16x4xf32>, %arg1: index, %arg2: index):
    %0 = "arith.constant"() {value = 0 : index} : () -> index
    %1 = "arith.constant"() {value = 1 : index} : () -> index
    %2 = "arith.constant"() {value = 2 : index} : () -> index
    %3 = "arith.constant"() {value = 7 : index} : () -> index
...
"builtin.module"() ({
  ...
  ^bb0(%arg0: index, %arg1: index, %arg2: index):
    ...
    "func.return"(%3) : (memref<?x?xf32>) -> ()
  }) {function_type = (index, index, index) -> memref<?x?xf32>, sym_name = "clone_nested_region"} : () -> ()
}) : () -> ()
