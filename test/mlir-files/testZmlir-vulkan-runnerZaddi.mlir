"builtin.module"() ({
  "gpu.module"() ({
    ...
    ^bb0(%arg0: memref<8xi32>, %arg1: memref<8x8xi32>, %arg2: memref<8x8x8xi32>):
      ...
      "gpu.return"() : () -> ()
    }) {function_type = (memref<8xi32>, memref<8x8xi32>, memref<8x8x8xi32>) -> (), gpu.kernel, spv.entry_point_abi = {local_size = dense<1> : vector<3xi32>}, sym_name = "kernel_addi", workgroup_attributions = 0 : i64} : () -> ()
    "gpu.module_end"() : () -> ()
  }) {sym_name = "kernels"} : () -> ()
  "func.func"() ({
    %0 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<8xi32>
    %1 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<8x8xi32>
    %2 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<8x8x8xi32>
    %3 = "arith.constant"() {value = 0 : i32} : () -> i32
    %4 = "arith.constant"() {value = 1 : i32} : () -> i32
    %5 = "arith.constant"() {value = 2 : i32} : () -> i32
    %6 = "memref.cast"(%0) : (memref<8xi32>) -> memref<?xi32>
    %7 = "memref.cast"(%1) : (memref<8x8xi32>) -> memref<?x?xi32>
    %8 = "memref.cast"(%2) : (memref<8x8x8xi32>) -> memref<?x?x?xi32>
    "func.call"(%6, %4) {callee = @fillResource1DInt} : (memref<?xi32>, i32) -> ()
    ...
    "gpu.launch_func"(%10, %10, %10, %9, %9, %9, %0, %1, %2) {kernel = @kernels::@kernel_addi, operand_segment_sizes = dense<[0, 1, 1, 1, 1, 1, 1, 0, 3]> : vector<9xi32>} : (index, index, index, index, index, index, memref<8xi32>, memref<8x8xi32>, memref<8x8x8xi32>) -> ()
    %11 = "memref.cast"(%8) : (memref<?x?x?xi32>) -> memref<*xi32>
    "func.call"(%11) {callee = @print_memref_i32} : (memref<*xi32>) -> ()
    "func.return"() : () -> ()
  }) {function_type = () -> (), sym_name = "main"} : () -> ()
  "func.func"() ({
  }) {function_type = (memref<?xi32>, i32) -> (), sym_name = "fillResource1DInt", sym_visibility = "private"} : () -> ()
  "func.func"() ({
