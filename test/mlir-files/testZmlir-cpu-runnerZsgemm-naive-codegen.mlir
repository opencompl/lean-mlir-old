...
"builtin.module"() ({
  "func.func"() ({
    %0 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<16x16xf32>
    %1 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<16x16xf32>
    %2 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<16x16xf32>
    %3 = "arith.constant"() {value = 1.000000e+00 : f32} : () -> f32
    "linalg.fill"(%3, %0) ({
    ^bb0(%arg0: f32, %arg1: f32):
      "linalg.yield"(%arg0) : (f32) -> ()
    }) {operand_segment_sizes = dense<1> : vector<2xi32>} : (f32, memref<16x16xf32>) -> ()
    "linalg.fill"(%3, %1) ({
    ^bb0(%arg0: f32, %arg1: f32):
      "linalg.yield"(%arg0) : (f32) -> ()
    }) {operand_segment_sizes = dense<1> : vector<2xi32>} : (f32, memref<16x16xf32>) -> ()
  ...
  ^bb0(%arg0: memref<16x16xf32>, %arg1: memref<16x16xf32>, %arg2: memref<16x16xf32>):
    ...
    ^bb0(%arg3: index):
      "affine.for"() ({
      ^bb0(%arg4: index):
        %1 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<1xf32>
        %2 = "affine.load"(%arg2, %arg3, %arg4) {map = #map3} : (memref<16x16xf32>, index, index) -> f32
        "affine.store"(%2, %1, %0) {map = #map4} : (f32, memref<1xf32>, index) -> ()
        "affine.for"() ({
        ^bb0(%arg5: index):
