...
"builtin.module"() ({
  ...
  "func.func"() ({
    ...
    %3 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<2x3xf32>
    ...
    %6 = "memref.cast"(%3) : (memref<2x3xf32>) -> memref<* × f32>
    "func.call"(%6) {callee = @print_memref_f32} : (memref<* × f32>) -> ()
    %7 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<2x3xf32>
    "memref.copy"(%3, %7) : (memref<2x3xf32>, memref<2x3xf32>) -> ()
    %8 = "memref.cast"(%7) : (memref<2x3xf32>) -> memref<* × f32>
    "func.call"(%8) {callee = @print_memref_f32} : (memref<* × f32>) -> ()
    %9 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<3x2xf32>
    %10 = "memref.reinterpret_cast"(%9) {operand_segment_sizes = dense<[1, 0, 0, 0]> : vector<4 × i32>, static_offsets = [0], static_sizes = [2, 3], static_strides = [1, 2]} : (memref<3x2xf32>) -> memref<2x3xf32, #map0>
    "memref.copy"(%3, %10) : (memref<2x3xf32>, memref<2x3xf32, #map0>) -> ()
    %11 = "memref.cast"(%9) : (memref<3x2xf32>) -> memref<* × f32>
    "func.call"(%11) {callee = @print_memref_f32} : (memref<* × f32>) -> ()
    %12 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<3x0x1xf32>
    %13 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<3x0x1xf32>
    "memref.copy"(%12, %13) : (memref<3x0x1xf32>, memref<3x0x1xf32>) -> ()
    %14 = "memref.reinterpret_cast"(%12) {operand_segment_sizes = dense<[1, 0, 0, 0]> : vector<4 × i32>, static_offsets = [0], static_sizes = [0, 3, 1], static_strides = [3, 1, 1]} : (memref<3x0x1xf32>) -> memref<0x3x1xf32, #map1>
    %15 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<0x3x1xf32>
