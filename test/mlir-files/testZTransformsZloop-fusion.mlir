...
"builtin.module"() ({
  "func.func"() ({
    ...
    "affine.for"() ({
    ^bb0(%arg0: index):
      %2 = "affine.load"(%0, %arg0) {map = #map0} : (memref<10xf32>, index) -> f32
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
    "func.return"() : () -> ()
  ...
  "func.func"() ({
    ...
    ^bb0(%arg0: index):
      ...
      ^bb0(%arg1: index):
        ...
        "affine.store"(%6, %1, %arg0) {map = #map0} : (f32, memref<10xf32>, index) -> ()
        "affine.yield"() : () -> ()
    ...
    ^bb0(%arg0: index):
      %4 = "affine.load"(%1, %arg0) {map = #map0} : (memref<10xf32>, index) -> f32
      "affine.store"(%4, %2, %arg0) {map = #map0} : (f32, memref<10xf32>, index) -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map2, step = 1 : index, upper_bound = #map3} : () -> ()
    "func.return"() : () -> ()
...
"builtin.module"() ({
  "func.func"() ({
    ...
    ^bb0(%arg0: index):
      "affine.for"() ({
      ^bb0(%arg1: index):
        "affine.store"(%1, %0, %arg0, %arg1) {map = #map0} : (f32, memref<10x10xf32>, index, index) -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
    ...
    ^bb0(%arg0: index):
      "affine.for"() ({
      ^bb0(%arg1: index):
        %2 = "affine.load"(%0, %arg0, %arg1) {map = #map3} : (memref<10x10xf32>, index, index) -> f32
        "affine.yield"() : () -> ()
...
"builtin.module"() ({
  "func.func"() ({
    %0 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<10x10xf32>
    %1 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<10x10xf32>
    ...
    ^bb0(%arg0: index):
      "affine.for"() ({
      ^bb0(%arg1: index):
        %3 = "affine.load"(%0, %arg1, %arg0) {map = #map0} : (memref<10x10xf32>, index, index) -> f32
        "affine.store"(%3, %1, %arg0, %arg1) {map = #map0} : (f32, memref<10x10xf32>, index, index) -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
    ...
    ^bb0(%arg0: index):
      "affine.for"() ({
      ^bb0(%arg1: index):
        %3 = "affine.load"(%1, %arg0, %arg1) {map = #map0} : (memref<10x10xf32>, index, index) -> f32
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
...
"builtin.module"() ({
  "func.func"() ({
    ...
    ^bb0(%arg0: index):
      ...
      "affine.store"(%4, %1, %arg0) {map = #map0} : (f32, memref<10xf32>, index) -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
    "affine.for"() ({
    ^bb0(%arg0: index):
...
"builtin.module"() ({
  "func.func"() ({
    ...
    %3 = "affine.load"(%0, %2) {map = #map0} : (memref<10xf32>, index) -> f32
    "func.return"() : () -> ()
...
"builtin.module"() ({
  "func.func"() ({
    ...
    %2 = "affine.load"(%0) {map = #map4} : (memref<100xf32>) -> f32
    "func.return"() : () -> ()
...
"builtin.module"() ({
  "func.func"() ({
    ...
    "func.return"(%0) : (memref<10xf32>) -> ()
  }) {function_type = () -> memref<10xf32>, sym_name = "should_fuse_if_op_in_loop_nest_not_sandwiched"} : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() ({
    ...
    "func.return"(%1) : (memref<10xf32>) -> ()
  }) {function_type = () -> memref<10xf32>, sym_name = "should_not_fuse_if_op_in_loop_nest_between_src_and_dest"} : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() ({
    %0 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<10x20x30xf32>
    %1 = "arith.constant"() {value = 7.000000e+00 : f32} : () -> f32
    "affine.for"() ({
    ^bb0(%arg0: index):
      "affine.for"() ({
      ^bb0(%arg1: index):
        "affine.for"() ({
        ^bb0(%arg2: index):
          "affine.store"(%1, %0, %arg0, %arg1, %arg2) {map = #map0} : (f32, memref<10x20x30xf32>, index, index, index) -> ()
          "affine.yield"() : () -> ()
        }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map3} : () -> ()
    ...
    ^bb0(%arg0: index):
      ...
      ^bb0(%arg1: index):
        "affine.for"() ({
        ^bb0(%arg2: index):
          %2 = "affine.load"(%0, %arg1, %arg2, %arg0) {map = #map0} : (memref<10x20x30xf32>, index, index, index) -> f32
          "foo"(%2) : (f32) -> ()
          "affine.yield"() : () -> ()
        }) {lower_bound = #map1, step = 1 : index, upper_bound = #map3} : () -> ()
        "affine.yield"() : () -> ()
...
"builtin.module"() ({
  "func.func"() ({
  ^bb0(%arg0: memref<64xf32>):
    %0 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<16x4xf32>
    "affine.for"() ({
    ^bb0(%arg1: index):
      %1 = "affine.load"(%arg0, %arg1) {map = #map0} : (memref<64xf32>, index) -> f32
      "affine.store"(%1, %0, %arg1) {map = #map1} : (f32, memref<16x4xf32>, index) -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map2, step = 1 : index, upper_bound = #map3} : () -> ()
    "affine.for"() ({
    ^bb0(%arg1: index):
      "affine.for"() ({
      ^bb0(%arg2: index):
        %1 = "affine.load"(%0, %arg1, %arg2) {map = #map4} : (memref<16x4xf32>, index, index) -> f32
        "foo"(%1) : (f32) -> ()
        "affine.yield"() : () -> ()
    ...
    "func.return"() : () -> ()
  }) {function_type = (memref<64xf32>) -> (), sym_name = "fuse_reshape_64_16_4"} : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() ({
    %0 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<16x4xf32>
    %1 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<64xf32>
    "affine.for"() ({
    ^bb0(%arg0: index):
      "affine.for"() ({
      ^bb0(%arg1: index):
        %2 = "affine.load"(%0, %arg0, %arg1) {map = #map0} : (memref<16x4xf32>, index, index) -> f32
        "affine.store"(%2, %1, %arg0, %arg1) {map = #map1} : (f32, memref<64xf32>, index, index) -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map2, step = 1 : index, upper_bound = #map3} : () -> ()
      "affine.yield"() : () -> ()
    ...
    "affine.for"() ({
    ^bb0(%arg0: index):
      %2 = "affine.load"(%1, %arg0) {map = #map5} : (memref<64xf32>, index) -> f32
      "foo"(%2) : (f32) -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map2, step = 1 : index, upper_bound = #map6} : () -> ()
    "func.return"() : () -> ()
...
"builtin.module"() ({
  "func.func"() ({
    %0 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<2x2x3x3x16x1xi32>
    %1 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<64x9xi32>
    %2 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<64x9xi32>
    "affine.for"() ({
    ^bb0(%arg0: index):
      "affine.for"() ({
      ^bb0(%arg1: index):
    ...
    ^bb0(%arg0: index):
      ...
      ^bb0(%arg1: index):
        ...
        "affine.store"(%10, %1, %arg0, %arg1) {map = #map13} : (i32, memref<64x9xi32>, index, index) -> ()
        "affine.yield"() : () -> ()
    ...
    ^bb0(%arg0: index):
      "affine.for"() ({
      ^bb0(%arg1: index):
        %3 = "affine.load"(%1, %arg0, %arg1) {map = #map13} : (memref<64x9xi32>, index, index) -> i32
        %4 = "arith.muli"(%3, %3) : (i32, i32) -> i32
        "affine.store"(%4, %2, %arg0, %arg1) {map = #map13} : (i32, memref<64x9xi32>, index, index) -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map14} : () -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map15} : () -> ()
    "func.return"(%2) : (memref<64x9xi32>) -> ()
  }) {function_type = () -> memref<64x9xi32>, sym_name = "R6_to_R2_reshape_square"} : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  ...
  ^bb0(%arg0: index, %arg1: index):
    ...
    %1 = "memref.alloc"(%arg0, %0) {operand_segment_sizes = dense<[2, 0]> : vector<2xi32>} : (index, index) -> memref<?x?xf32>
    ...
    ^bb0(%arg2: index):
      "affine.for"(%arg1) ({
      ^bb0(%arg3: index):
        "affine.store"(%2, %1, %arg2, %arg3) {map = #map1} : (f32, memref<?x?xf32>, index, index) -> ()
        "affine.yield"() : () -> ()
    ...
    ^bb0(%arg2: index):
      "affine.for"(%arg1) ({
      ^bb0(%arg3: index):
        %4 = "affine.load"(%1, %arg2, %arg3, %3) {map = #map4} : (memref<?x?xf32>, index, index, index) -> f32
        "affine.yield"() : () -> ()
      }) {lower_bound = #map2, step = 1 : index, upper_bound = #map3} : (index) -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map2, step = 1 : index, upper_bound = #map3} : (index) -> ()
...
"builtin.module"() ({
  "func.func"() ({
    %0 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<10x100xf32>
    %1 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<10xf32>
    "affine.for"() ({
    ^bb0(%arg0: index):
      "affine.for"() ({
      ^bb0(%arg1: index):
        %2 = "affine.load"(%1, %arg0) {map = #map0} : (memref<10xf32>, index) -> f32
        %3 = "affine.load"(%0, %arg0, %arg1) {map = #map1} : (memref<10x100xf32>, index, index) -> f32
...
"builtin.module"() ({
  "func.func"() ({
    ...
    %1 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<100x16xf32>
    "affine.for"() ({
    ^bb0(%arg0: index):
      "affine.for"() ({
      ^bb0(%arg1: index):
        %2 = "affine.load"(%0, %arg0, %arg1) {map = #map0} : (memref<100x16xf32>, index, index) -> f32
        "op0"(%2) : (f32) -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
      "affine.for"() ({
      ^bb0(%arg1: index):
        %2 = "op1"() : () -> f32
        "affine.store"(%2, %1, %arg0, %arg1) {map = #map0} : (f32, memref<100x16xf32>, index, index) -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map3} : () -> ()
    ...
    ^bb0(%arg0: index):
      "affine.for"() ({
      ^bb0(%arg1: index):
        %2 = "affine.load"(%1, %arg0, %arg1) {map = #map0} : (memref<100x16xf32>, index, index) -> f32
        "op2"(%2) : (f32) -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
      "affine.yield"() : () -> ()
  ...
  "func.func"() ({
    ...
    ^bb0(%arg0: index):
      ...
      ^bb0(%arg1: index):
        ...
        %3 = "affine.load"(%0, %2) {map = #map0} : (memref<100xf32>, index) -> f32
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map4} : () -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map4} : () -> ()
...
"builtin.module"() ({
  "func.func"() ({
    ...
    "affine.for"() ({
    ^bb0(%arg0: index):
      %3 = "affine.load"(%0, %1) {map = #map0} : (memref<10xf32>, index) -> f32
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
    "func.return"() : () -> ()
...
"builtin.module"() ({
  "func.func"() ({
    %0 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<2x2x3x3x16x10xf32, 2>
    %1 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<2x2x3x3x16x10xf32, 2>
    %2 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<3x3x3x3x16x10xf32, 2>
...
"builtin.module"() ({
  "func.func"() ({
    %0 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<4x256xf32>
    %1 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<4x256xf32>
    ...
    ^bb0(%arg0: index):
      "affine.for"() ({
      ^bb0(%arg1: index):
        %4 = "affine.load"(%1, %arg0, %arg1) {map = #map0} : (memref<4x256xf32>, index, index) -> f32
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
      "affine.for"() ({
      ^bb0(%arg1: index):
        "affine.store"(%3, %0, %arg0, %arg1) {map = #map0} : (f32, memref<4x256xf32>, index, index) -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map3} : () -> ()
    ...
    ^bb0(%arg0: index):
      "affine.for"() ({
      ^bb0(%arg1: index):
        %4 = "affine.load"(%0, %arg0, %arg1) {map = #map0} : (memref<4x256xf32>, index, index) -> f32
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map4} : () -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map3} : () -> ()
...
"builtin.module"() ({
  "func.func"() ({
    ...
    ^bb0(%arg0: index):
      "affine.for"() ({
      ^bb0(%arg1: index):
        %3 = "affine.load"(%0, %arg1) {map = #map0} : (memref<100xf32>, index) -> f32
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map3} : () -> ()
      "affine.for"() ({
      ^bb0(%arg1: index):
        "affine.for"() ({
        ^bb0(%arg2: index):
          %3 = "affine.load"(%0, %arg2) {map = #map0} : (memref<100xf32>, index) -> f32
          "affine.yield"() : () -> ()
        }) {lower_bound = #map1, step = 1 : index, upper_bound = #map4} : () -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map3} : () -> ()
...
"builtin.module"() ({
  ...
  ^bb0(%arg0: memref<10xf32>):
    ...
    "func.return"() : () -> ()
  }) {function_type = (memref<10xf32>) -> (), sym_name = "should_fuse_live_out_arg_but_preserve_src_loop"} : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  ...
  ^bb0(%arg0: memref<10xf32>):
    ...
    "func.return"() : () -> ()
  }) {function_type = (memref<10xf32>) -> (), sym_name = "should_fuse_live_out_arg"} : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() ({
    ...
    "affine.for"() ({
    ^bb0(%arg0: index):
      "affine.store"(%0, %1, %arg0) {map = #map0} : (f32, memref<10xf32>, index) -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
    "affine.for"() ({
    ^bb0(%arg0: index):
    ...
    "func.return"(%1) : (memref<10xf32>) -> ()
  }) {function_type = () -> memref<10xf32>, sym_name = "should_fuse_escaping_memref_but_preserve_src_loop"} : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() ({
    %0 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<2x3x16xi32>
    %1 = "arith.constant"() {value = 0 : index} : () -> index
    "affine.for"() ({
    ^bb0(%arg0: index):
      "affine.for"() ({
      ^bb0(%arg1: index):
        ...
        ^bb0(%arg2: index):
          ...
          "affine.store"(%2, %0, %arg0, %arg1, %arg2) {map = #map0} : (i32, memref<2x3x16xi32>, index, index, index) -> ()
          "affine.yield"() : () -> ()
        }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map3} : () -> ()
    ...
    ^bb0(%arg0: index):
      ...
      ^bb0(%arg1: index):
        ...
        %4 = "affine.load"(%0, %3, %arg1, %1) {map = #map0} : (memref<2x3x16xi32>, index, index, index) -> i32
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map3} : () -> ()
      "affine.yield"() : () -> ()
...
"builtin.module"() ({
  "func.func"() ({
    ...
    ^bb0(%arg0: index):
      %4 = "affine.load"(%1, %arg0) {map = #map0} : (memref<10xf32>, index) -> f32
      "affine.store"(%4, %0, %arg0) {map = #map0} : (f32, memref<10xf32>, index) -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
    "affine.for"() ({
    ^bb0(%arg0: index):
...
"builtin.module"() ({
  "func.func"() ({
    ...
    "affine.for"() ({
    ^bb0(%arg0: index):
      %5 = "affine.load"(%1, %arg0) {map = #map0} : (memref<10xf32>, index) -> f32
      "affine.store"(%3, %0, %arg0) {map = #map0} : (f32, memref<10xf32>, index) -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
    "affine.for"() ({
    ...
    "affine.for"() ({
    ^bb0(%arg0: index):
      %5 = "affine.load"(%0, %arg0) {map = #map0} : (memref<10xf32>, index) -> f32
      "affine.store"(%4, %2, %arg0) {map = #map0} : (f32, memref<10xf32>, index) -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : () -> ()
    "func.return"() : () -> ()
