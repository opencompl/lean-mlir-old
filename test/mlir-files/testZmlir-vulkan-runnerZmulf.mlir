"builtin.module"() ({
  "gpu.module"() ({
    ...
    ^bb0(%arg0: memref<4x4xf32>, %arg1: memref<4x4xf32>, %arg2: memref<4x4xf32>):
      ...
      "gpu.return"() : () -> ()
    }) {function_type = (memref<4x4xf32>, memref<4x4xf32>, memref<4x4xf32>) -> (), gpu.kernel, spv.entry_point_abi = {local_size = dense<1> : vector<3xi32>}, sym_name = "kernel_mul", workgroup_attributions = 0 : i64} : () -> ()
    "gpu.module_end"() : () -> ()
  }) {sym_name = "kernels"} : () -> ()
  "func.func"() ({
    %0 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<4x4xf32>
    %1 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<4x4xf32>
    %2 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<4x4xf32>
    ...
    "gpu.launch_func"(%13, %13, %12, %12, %12, %12, %0, %1, %2) {kernel = @kernels::@kernel_mul, operand_segment_sizes = dense<[0, 1, 1, 1, 1, 1, 1, 0, 3]> : vector<9xi32>} : (index, index, index, index, index, index, memref<4x4xf32>, memref<4x4xf32>, memref<4x4xf32>) -> ()
    %14 = "memref.cast"(%11) : (memref<?x?xf32>) -> memref<*xf32>
