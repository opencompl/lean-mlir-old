"builtin.module"() ({
  ...
  "func.func"() ({
    "func.return"() : () -> ()
  }) {function_type = () -> (), sym_name = "simple2"} : () -> ()
  "func.func"() ({
    "test.op_crash"() : () -> ()
    "func.return"() : () -> ()
  }) {function_type = () -> (), sym_name = "simple3"} : () -> ()
  "func.func"() ({
  ...
  ^bb3(%1: memref<2 × f32>):  
    "test.op_crash"(%1, %arg2) : (memref<2 × f32>, memref<2 × f32>) -> ()
    "func.return"() : () -> ()
  }) {function_type = (i1, memref<2 × f32>, memref<2 × f32>) -> (), sym_name = "simple4"} : () -> ()
  "func.func"() ({
    "func.return"() : () -> ()
