"builtin.module"() ({
  "builtin.module"() ({
    ...
    ^bb2:  // pred: ^bb1
      "pdl_interp.record_match"(%arg0, %arg0)[^bb3] {benefit = 1 : i16, operand_segment_sizes = dense<1> : vector<2xi32>, rewriter = @rewriters::@success} : (!pdl.operation, !pdl.operation) -> ()
    ...
    "builtin.module"() ({
      "pdl_interp.func"() ({
      ^bb0(%arg0: !pdl.operation):
        %0 = "pdl_interp.create_operation"() {inputAttributeNames = [], name = "test.replaced_by_pattern", operand_segment_sizes = dense<0> : vector<3xi32>} : () -> !pdl.operation
...
"builtin.module"() ({
  "builtin.module"() ({
    ...
    ^bb1:  // pred: ^bb0
      "pdl_interp.record_match"(%arg0, %arg0)[^bb2] {benefit = 1 : i16, operand_segment_sizes = dense<1> : vector<2xi32>, rewriter = @rewriters::@success} : (!pdl.operation, !pdl.operation) -> ()
    ^bb2:  // 2 preds: ^bb0, ^bb1
      "pdl_interp.finalize"() : () -> ()
    }) {function_type = (!pdl.operation) -> (), sym_name = "matcher"} : () -> ()
    "builtin.module"() ({
  ...
  "builtin.module"() ({
    ...
    "builtin.module"() ({
      ...
      ^bb0(%arg0: !pdl.operation):
        ...
        %1 = "pdl_interp.create_operation"(%0#0, %0#1) {inputAttributeNames = [], name = "test.success", operand_segment_sizes = dense<[1, 0, 1]> : vector<3xi32>} : (!pdl.range<value>, !pdl.range<type>) -> !pdl.operation
  ...
  "builtin.module"() ({
    ...
    "builtin.module"() ({
      ...
      ^bb0(%arg0: !pdl.operation):
        ...
        %1 = "pdl_interp.create_operation"(%0) {inputAttributeNames = [], name = "test.success", operand_segment_sizes = dense<[0, 0, 1]> : vector<3xi32>} : (!pdl.type) -> !pdl.operation
        "pdl_interp.erase"(%arg0) : (!pdl.operation) -> ()
        "pdl_interp.finalize"() : () -> ()
      }) {function_type = (!pdl.operation) -> (), sym_name = "success"} : () -> ()
    }) {sym_name = "rewriters"} : () -> ()
...
"builtin.module"() ({
  "builtin.module"() ({
    ...
    "builtin.module"() ({
      "pdl_interp.func"() ({
      ^bb0(%arg0: !pdl.operation):
        %0 = "pdl_interp.create_operation"() {inputAttributeNames = [], name = "test.success", operand_segment_sizes = dense<0> : vector<3xi32>} : () -> !pdl.operation
        "pdl_interp.erase"(%arg0) : (!pdl.operation) -> ()
        "pdl_interp.finalize"() : () -> ()
      }) {function_type = (!pdl.operation) -> (), sym_name = "success"} : () -> ()
    }) {sym_name = "rewriters"} : () -> ()
...
"builtin.module"() ({
  "builtin.module"() ({
    ...
    ^bb2:  // pred: ^bb1
      "pdl_interp.record_match"(%arg0, %arg0)[^bb3] {benefit = 2 : i16, operand_segment_sizes = dense<1> : vector<2xi32>, rewriter = @rewriters::@success} : (!pdl.operation, !pdl.operation) -> ()
    ^bb3:  // 2 preds: ^bb0, ^bb2
      "pdl_interp.finalize"() : () -> ()
    }) {function_type = (!pdl.operation) -> (), sym_name = "matcher"} : () -> ()
    "builtin.module"() ({
...
"builtin.module"() ({
  "builtin.module"() ({
    ...
    ^bb1:  // pred: ^bb0
      "pdl_interp.record_match"(%2, %arg0)[^bb2] {benefit = 1 : i16, operand_segment_sizes = dense<1> : vector<2xi32>, rewriter = @rewriters::@success} : (!pdl.operation, !pdl.operation) -> ()
    ^bb2:  // 2 preds: ^bb0, ^bb1
      "pdl_interp.finalize"() : () -> ()
    }) {function_type = (!pdl.operation) -> (), sym_name = "matcher"} : () -> ()
    "builtin.module"() ({
    ...
    ^bb0(%arg0: !pdl.operation):
      ...
      ^bb0(%arg1: !pdl.operation):
        ...
        ^bb0(%arg2: !pdl.operation):
          "pdl_interp.record_match"(%arg2, %arg0)[^bb1] {benefit = 1 : i16, operand_segment_sizes = dense<1> : vector<2xi32>, rewriter = @rewriters::@success} : (!pdl.operation, !pdl.operation) -> ()
        ^bb1:  // pred: ^bb0
          "pdl_interp.continue"() : () -> ()
        }) : (!pdl.range<operation>) -> ()
      ^bb1:  // pred: ^bb0
...
"builtin.module"() ({
  "builtin.module"() ({
    ...
    ^bb0(%arg0: !pdl.operation):
      ...
      "pdl_interp.foreach"(%1)[^bb1] ({
      ^bb0(%arg1: !pdl.operation):
        "pdl_interp.record_match"(%arg1, %arg0)[^bb1] {benefit = 1 : i16, operand_segment_sizes = dense<1> : vector<2xi32>, rewriter = @rewriters::@success} : (!pdl.operation, !pdl.operation) -> ()
      ^bb1:  // pred: ^bb0
        "pdl_interp.continue"() : () -> ()
      }) : (!pdl.range<operation>) -> ()
    ^bb1:  // pred: ^bb0
...
"builtin.module"() ({
  "builtin.module"() ({
    ...
    ^bb8:  // pred: ^bb7
      "pdl_interp.record_match"(%arg0, %0, %2, %4, %5, %arg0)[^bb9] {benefit = 1 : i16, operand_segment_sizes = dense<[5, 1]> : vector<2xi32>, rewriter = @rewriters::@success} : (!pdl.operation, !pdl.range<value>, !pdl.range<value>, !pdl.range<value>, !pdl.value, !pdl.operation) -> ()
    ...
    "builtin.module"() ({
      ...
      ^bb0(%arg0: !pdl.operation, %arg1: !pdl.range<value>, %arg2: !pdl.range<value>, %arg3: !pdl.range<value>, %arg4: !pdl.value):
        %0 = "pdl_interp.create_operation"(%arg1) {inputAttributeNames = [], name = "test.success", operand_segment_sizes = dense<[1, 0, 0]> : vector<3xi32>} : (!pdl.range<value>) -> !pdl.operation
        %1 = "pdl_interp.create_operation"(%arg2) {inputAttributeNames = [], name = "test.success", operand_segment_sizes = dense<[1, 0, 0]> : vector<3xi32>} : (!pdl.range<value>) -> !pdl.operation
        %2 = "pdl_interp.create_operation"(%arg3) {inputAttributeNames = [], name = "test.success", operand_segment_sizes = dense<[1, 0, 0]> : vector<3xi32>} : (!pdl.range<value>) -> !pdl.operation
        %3 = "pdl_interp.create_operation"(%arg4) {inputAttributeNames = [], name = "test.success", operand_segment_sizes = dense<[1, 0, 0]> : vector<3xi32>} : (!pdl.value) -> !pdl.operation
        "pdl_interp.erase"(%arg0) : (!pdl.operation) -> ()
        "pdl_interp.finalize"() : () -> ()
  ...
  "builtin.module"() ({
    ...
    "test.attr_sized_operands"(%0#0, %0#1, %0#2, %0#3, %0#4) {operand_segment_sizes = dense<[0, 4, 1, 0]> : vector<4xi32>} : (i32, i32, i32, i32, i32) -> ()
...
"builtin.module"() ({
  "builtin.module"() ({
    ...
    "builtin.module"() ({
      ...
      ^bb0(%arg0: !pdl.operation, %arg1: !pdl.range<value>, %arg2: !pdl.range<value>, %arg3: !pdl.range<value>, %arg4: !pdl.value):
        ...
        %4 = "pdl_interp.create_operation"(%0) {inputAttributeNames = [], name = "test.success", operand_segment_sizes = dense<[0, 0, 1]> : vector<3xi32>} : (!pdl.range<type>) -> !pdl.operation
        %5 = "pdl_interp.create_operation"(%1) {inputAttributeNames = [], name = "test.success", operand_segment_sizes = dense<[0, 0, 1]> : vector<3xi32>} : (!pdl.range<type>) -> !pdl.operation
        %6 = "pdl_interp.create_operation"(%2) {inputAttributeNames = [], name = "test.success", operand_segment_sizes = dense<[0, 0, 1]> : vector<3xi32>} : (!pdl.range<type>) -> !pdl.operation
        %7 = "pdl_interp.create_operation"(%3) {inputAttributeNames = [], name = "test.success", operand_segment_sizes = dense<[0, 0, 1]> : vector<3xi32>} : (!pdl.type) -> !pdl.operation
  ...
  "builtin.module"() ({
    %0:5 = "test.attr_sized_results"() {result_segment_sizes = dense<[0, 4, 1, 0]> : vector<4xi32>} : () -> (i32, i32, i32, i32, i32)
...
"builtin.module"() ({
  "builtin.module"() ({
    ...
    ^bb0(%arg0: !pdl.operation):
      "pdl_interp.check_operation_name"(%arg0)[^bb1, ^bb3] {name = "test.op"} : (!pdl.operation) -> ()
    ^bb1:  // pred: ^bb0
      "pdl_interp.record_match"(%arg0, %arg0)[^bb2] {benefit = 1 : i16, operand_segment_sizes = dense<1> : vector<2xi32>, rewriter = @rewriters::@failure} : (!pdl.operation, !pdl.operation) -> ()
    ^bb2:  // pred: ^bb1
      "pdl_interp.record_match"(%arg0, %arg0)[^bb3] {benefit = 2 : i16, operand_segment_sizes = dense<1> : vector<2xi32>, rewriter = @rewriters::@success} : (!pdl.operation, !pdl.operation) -> ()
    ^bb3:  // 2 preds: ^bb0, ^bb2
      "pdl_interp.finalize"() : () -> ()
...
"builtin.module"() ({
  "builtin.module"() ({
    ...
    ^bb1:  // pred: ^bb0
      ...
      %1 = "pdl_interp.get_results"(%arg0) : (!pdl.operation) -> !pdl.range<value>
      %2 = "pdl_interp.get_value_type"(%1) : (!pdl.range<value>) -> !pdl.range<type>
      "pdl_interp.record_match"(%0, %2, %arg0, %arg0)[^bb2] {benefit = 1 : i16, operand_segment_sizes = dense<[3, 1]> : vector<2xi32>, rewriter = @rewriters::@success} : (!pdl.range<value>, !pdl.range<type>, !pdl.operation, !pdl.operation) -> ()
    ^bb2:  // 2 preds: ^bb0, ^bb1
      "pdl_interp.finalize"() : () -> ()
    }) {function_type = (!pdl.operation) -> (), sym_name = "matcher"} : () -> ()
    "builtin.module"() ({
      ...
      ^bb0(%arg0: !pdl.range<value>, %arg1: !pdl.range<type>, %arg2: !pdl.operation):
        %0 = "pdl_interp.create_operation"(%arg0, %arg1) {inputAttributeNames = [], name = "test.success", operand_segment_sizes = dense<[1, 0, 1]> : vector<3xi32>} : (!pdl.range<value>, !pdl.range<type>) -> !pdl.operation
...
"builtin.module"() ({
  "builtin.module"() ({
    "pdl_interp.func"() ({
    ^bb0(%arg0: !pdl.operation):
      "pdl_interp.switch_operand_count"(%arg0)[^bb3, ^bb3, ^bb1] {caseValues = dense<[0, 1]> : vector<2xi32>} : (!pdl.operation) -> ()
    ^bb1:  // pred: ^bb0
      "pdl_interp.switch_operand_count"(%arg0)[^bb2, ^bb3, ^bb3] {caseValues = dense<[0, 2]> : vector<2xi32>} : (!pdl.operation) -> ()
    ^bb2:  // pred: ^bb1
      "pdl_interp.record_match"(%arg0, %arg0)[^bb3] {benefit = 1 : i16, operand_segment_sizes = dense<1> : vector<2xi32>, rewriter = @rewriters::@success} : (!pdl.operation, !pdl.operation) -> ()
    ^bb3:  // 5 preds: ^bb0, ^bb0, ^bb1, ^bb1, ^bb2
      "pdl_interp.finalize"() : () -> ()
...
"builtin.module"() ({
  "builtin.module"() ({
    "pdl_interp.func"() ({
    ^bb0(%arg0: !pdl.operation):
      "pdl_interp.switch_result_count"(%arg0)[^bb3, ^bb3, ^bb1] {caseValues = dense<[0, 1]> : vector<2xi32>} : (!pdl.operation) -> ()
    ^bb1:  // pred: ^bb0
      "pdl_interp.switch_result_count"(%arg0)[^bb2, ^bb3, ^bb3] {caseValues = dense<[0, 2]> : vector<2xi32>} : (!pdl.operation) -> ()
    ^bb2:  // pred: ^bb1
      "pdl_interp.record_match"(%arg0, %arg0)[^bb3] {benefit = 1 : i16, operand_segment_sizes = dense<1> : vector<2xi32>, rewriter = @rewriters::@success} : (!pdl.operation, !pdl.operation) -> ()
    ^bb3:  // 5 preds: ^bb0, ^bb0, ^bb1, ^bb1, ^bb2
      "pdl_interp.finalize"() : () -> ()
...
"builtin.module"() ({
  "builtin.module"() ({
    ...
    ^bb3:  // pred: ^bb2
      "pdl_interp.record_match"(%arg0, %arg0)[^bb4] {benefit = 1 : i16, operand_segment_sizes = dense<1> : vector<2xi32>, rewriter = @rewriters::@success} : (!pdl.operation, !pdl.operation) -> ()
