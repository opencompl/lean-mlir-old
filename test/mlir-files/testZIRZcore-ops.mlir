...
"builtin.module"() ({
  "func.func"() ({
  ^bb0(%arg0: f32):
    %0 = "getTensor"() : () -> tensor<4 × 4 × ? × f32>
    %1 = "arith.constant"() {value = 2 : index} : () -> index
    %2 = "tensor.dim"(%0, %1) : (tensor<4 × 4 × ? × f32>, index) -> index
  ...
  ^bb0(%arg0: tensor<4 × 4 × ? × f32>, %arg1: f32, %arg2: i32, %arg3: index, %arg4: i64, %arg5: f16):
    ...
    %1 = "tensor.dim"(%arg0, %0) : (tensor<4 × 4 × ? × f32>, index) -> index
    ...
    %10 = "arith.constant"() {value = dense<0> : tensor<42 × i32>} : () -> tensor<42 × i32>
    %11 = "arith.constant"() {value = dense<0> : vector<42 × i32>} : () -> vector<42 × i32>
    %12 = "arith.constant"() {value = dense<true> : tensor<42 × i1>} : () -> tensor<42 × i1>
    %13 = "arith.constant"() {value = dense<true> : vector<42 × i1>} : () -> vector<42 × i1>
    %14 = "arith.select"(%9, %arg3, %arg3) : (i1, index, index) -> index
    %15 = "arith.select"(%12, %10, %10) : (tensor<42 × i1>, tensor<42 × i32>, tensor<42 × i32>) -> tensor<42 × i32>
    ...
    %26 = "arith.cmpf"(%20, %20) {predicate = 1 : i64} : (tensor<42 × f32>, tensor<42 × f32>) -> tensor<42 × i1>
    ...
    %33 = "math.abs"(%arg0) : (tensor<4 × 4 × ? × f32>) -> tensor<4 × 4 × ? × f32>
    %34 = "math.ceil"(%arg1) : (f32) -> f32
    %35 = "math.ceil"(%arg1) : (f32) -> f32
    %36 = "math.ceil"(%21) : (vector<4 × f32>) -> vector<4 × f32>
    %37 = "math.ceil"(%arg0) : (tensor<4 × 4 × ? × f32>) -> tensor<4 × 4 × ? × f32>
  ...
  "func.func"() ({
  ^bb0(%arg0: memref<4 × 4 × i32>, %arg1: index):
    %0 = "memref.load"(%arg0, %arg1, %arg1) : (memref<4 × 4 × i32>, index, index) -> i32
    %1 = "memref.load"(%arg0, %arg1, %arg1) : (memref<4 × 4 × i32>, index, index) -> i32
    "memref.prefetch"(%arg0, %arg1, %arg1) {isDataCache = true, isWrite = true, localityHint = 1 : i32} : (memref<4 × 4 × i32>, index, index) -> ()
    "memref.prefetch"(%arg0, %arg1, %arg1) {isDataCache = false, isWrite = false, localityHint = 3 : i32} : (memref<4 × 4 × i32>, index, index) -> ()
    "func.return"() : () -> ()
  }) {function_type = (memref<4 × 4 × i32>, index) -> (), sym_name = "load_store_prefetch"} : () -> ()
  "func.func"() ({
  ...
  ^bb0(%arg0: memref<4 × f32>, %arg1: memref<? × f32>, %arg2: memref<64 × 16 × 4 × f32, #map2>):
    ...
    %4 = "memref.cast"(%1) : (memref<4 × f32>) -> memref<* × f32>
  ...
  "func.func"() ({
  }) {function_type = (memref<* × f32, 4>) -> (), sym_name = "unranked_memref_roundtrip", sym_visibility = "private"} : () -> ()
  "func.func"() ({
  ^bb0(%arg0: index, %arg1: index, %arg2: index):
    %0 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<2048 × i8>
    %1 = "memref.view"(%0, %arg2, %arg0, %arg1) : (memref<2048 × i8>, index, index, index) -> memref<? × ? × f32>
    %2 = "memref.view"(%0, %arg2, %arg1) : (memref<2048 × i8>, index, index) -> memref<4 × ? × f32>
    %3 = "arith.constant"() {value = 0 : index} : () -> index
    %4 = "memref.view"(%0, %3) : (memref<2048 × i8>, index) -> memref<64 × 4 × f32>
    "func.return"() : () -> ()
  }) {function_type = (index, index, index) -> (), sym_name = "memref_view"} : () -> ()
  "func.func"() ({
  ^bb0(%arg0: tensor<4 × 4 × ? × f32>):
    %0 = "arith.constant"() {value = 2 : index} : () -> index
    %1 = "tensor.dim"(%arg0, %0) : (tensor<4 × 4 × ? × f32>, index) -> index
    %2 = "affine.apply"(%1) {map = #map4} : (index) -> index
    "func.return"() : () -> ()
  }) {function_type = (tensor<4 × 4 × ? × f32>) -> (), sym_name = "test_dimop"} : () -> ()
  "func.func"() ({
  ^bb0(%arg0: memref<4 × 4 × i32>, %arg1: tensor<4 × 4 × i32>):
    "memref.tensor_store"(%arg1, %arg0) : (tensor<4 × 4 × i32>, memref<4 × 4 × i32>) -> ()
    "func.return"() : () -> ()
  }) {function_type = (memref<4 × 4 × i32>, tensor<4 × 4 × i32>) -> (), sym_name = "tensor_load_store"} : () -> ()
  "func.func"() ({
  ...
  "func.func"() ({
  ^bb0(%arg0: memref<4 × 4 × f16>):
    "memref.assume_alignment"(%arg0) {alignment = 16 : i32} : (memref<4 × 4 × f16>) -> ()
    "func.return"() : () -> ()
