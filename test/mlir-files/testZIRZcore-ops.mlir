...
"builtin.module"() ({
  ...
  "func.func"() ({
  ^bb0(%arg0: memref<4 × f32>, %arg1: memref<? × f32>, %arg2: memref<64x16x4xf32, #map2>):
    ...
    "func.return"() : () -> ()
  }) {function_type = (memref<4 × f32>, memref<? × f32>, memref<64x16x4xf32, #map2>) -> (), sym_name = "memref_cast"} : () -> ()
  "func.func"() ({
  ...
  ^bb0(%arg0: index, %arg1: index, %arg2: index):
    ...
    %1 = "memref.view"(%0, %arg2, %arg0, %arg1) : (memref<2048 × i8>, index, index, index) -> memref<?x?xf32>
    %2 = "memref.view"(%0, %arg2, %arg1) : (memref<2048 × i8>, index, index) -> memref<4x?xf32>
    %3 = "arith.constant"() {value = 0 : index} : () -> index
    %4 = "memref.view"(%0, %3) : (memref<2048 × i8>, index) -> memref<64x4xf32>
    "func.return"() : () -> ()
