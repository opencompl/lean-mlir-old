"builtin.module"() ({
  ...
  ^bb0(%arg0: memref<2 × f32>, %arg1: memref<2 × f32>):
    %0 = "memref.alloca"() {operand_segment_sizes = dense<0> : vector<2 × i32>, test.ptr = "alloca_1"} : () -> memref<8x64xf32>
    %1 = "memref.alloca"() {operand_segment_sizes = dense<0> : vector<2 × i32>, test.ptr = "alloca_2"} : () -> memref<8x64xf32>
    %2 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>, test.ptr = "alloc_1"} : () -> memref<8x64xf32>
    %3 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>, test.ptr = "alloc_2"} : () -> memref<8x64xf32>
    "func.return"() : () -> ()
...
"builtin.module"() ({
  ...
  ^bb0(%arg0: memref<2 × f32>, %arg1: i1):
    ...
    %1 = "memref.alloca"() {operand_segment_sizes = dense<0> : vector<2 × i32>, test.ptr = "alloca_2"} : () -> memref<8x64xf32>
    %2 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>, test.ptr = "alloc_1"} : () -> memref<8x64xf32>
    "cf.cond_br"(%arg1, %0, %0)[^bb1, ^bb2] {operand_segment_sizes = dense<1> : vector<3 × i32>} : (i1, memref<8x64xf32>, memref<8x64xf32>) -> ()
...
"builtin.module"() ({
  ...
  ^bb0(%arg0: memref<2 × f32>, %arg1: i1):
    ...
    %1 = "memref.alloca"() {operand_segment_sizes = dense<0> : vector<2 × i32>, test.ptr = "alloca_2"} : () -> memref<8x64xf32>
    %2 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>, test.ptr = "alloc_1"} : () -> memref<8x64xf32>
    "cf.cond_br"(%arg1, %0, %2)[^bb1, ^bb2] {operand_segment_sizes = dense<1> : vector<3 × i32>} : (i1, memref<8x64xf32>, memref<8x64xf32>) -> ()
  ^bb1(%3: memref<8x64xf32>):  // pred: ^bb0
    "cf.br"(%3)[^bb2] : (memref<8x64xf32>) -> ()
  ^bb2(%4: memref<8x64xf32>):  // 2 preds: ^bb0, ^bb1
    "func.return"() : () -> ()
...
"builtin.module"() ({
  ...
  ^bb0(%arg0: memref<2 × f32>, %arg1: index):
    %0 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>, test.ptr = "alloc_1"} : () -> memref<8x64xf32>
    %1 = "arith.constant"() {value = 0 : index} : () -> index
    %2 = "memref.alloca"(%arg1) {operand_segment_sizes = dense<[1, 0]> : vector<2 × i32>, test.ptr = "alloca_1"} : (index) -> memref<? × i8>
    %3 = "memref.view"(%2, %1) {test.ptr = "view"} : (memref<? × i8>, index) -> memref<8x64xf32>
    "func.return"() : () -> ()
