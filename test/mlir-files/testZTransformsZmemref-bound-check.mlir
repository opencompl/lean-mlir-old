...
"builtin.module"() ({
  "func.func"() ({
    ...
    %3 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<9x9xi32>
    %4 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<111xi32>
    "affine.for"() ({
    ^bb0(%arg0: index):
      "affine.for"() ({
      ^bb0(%arg1: index):
        ...
        %7 = "affine.load"(%3, %5, %6) {map = #map2} : (memref<9x9xi32>, index, index) -> i32
        %8 = "affine.apply"(%arg0, %arg1) {map = #map3} : (index, index) -> index
        %9 = "affine.load"(%4, %8) {map = #map4} : (memref<111xi32>, index) -> i32
        "affine.yield"() : () -> ()
    ...
    "affine.for"() ({
    ^bb0(%arg0: index):
      %5 = "affine.load"(%4, %0) {map = #map4} : (memref<111xi32>, index) -> i32
      %6 = "affine.load"(%4, %2) {map = #map4} : (memref<111xi32>, index) -> i32
      "affine.store"(%6, %4, %1) {map = #map4} : (i32, memref<111xi32>, index) -> ()
      "affine.yield"() : () -> ()
  ...
  "func.func"() ({
    %0 = "arith.constant"() {value = 0 : index} : () -> index
    %1 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<128x64x64xi32>
    "affine.for"() ({
    ^bb0(%arg0: index):
      "affine.for"() ({
      ^bb0(%arg1: index):
        ...
        %5 = "affine.load"(%1, %2, %3, %4) {map = #map11} : (memref<128x64x64xi32>, index, index, index) -> i32
        ...
        "affine.store"(%5, %1, %6, %7, %8) {map = #map11} : (i32, memref<128x64x64xi32>, index, index, index) -> ()
        "affine.yield"() : () -> ()
  ...
  "func.func"() ({
    %0 = "arith.constant"() {value = 0 : index} : () -> index
    %1 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<257x256xi32>
    %2 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<257xi32>
    ...
    ^bb0(%arg0: index):
      ...
      ^bb0(%arg1: index):
        ...
        %5 = "affine.load"(%1, %4, %0) {map = #map2} : (memref<257x256xi32>, index, index) -> i32
        %6 = "affine.apply"(%arg0, %arg0) {map = #map17} : (index, index) -> index
        %7 = "affine.load"(%3, %6) {map = #map4} : (memref<1xi32>, index) -> i32
        "affine.yield"() : () -> ()
      }) {lower_bound = #map7, step = 1 : index, upper_bound = #map15} : () -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map7, step = 1 : index, upper_bound = #map15} : () -> ()
  ...
  "func.func"() ({
    %0 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<256x256xi32>
    "affine.for"() ({
    ^bb0(%arg0: index):
      "affine.for"() ({
      ^bb0(%arg1: index):
        ...
        %3 = "affine.load"(%0, %1, %2) {map = #map2} : (memref<256x256xi32>, index, index) -> i32
        "affine.yield"() : () -> ()
      }) {lower_bound = #map7, step = 1 : index, upper_bound = #map15} : () -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map7, step = 1 : index, upper_bound = #map15} : () -> ()
  ...
  "func.func"() ({
  ^bb0(%arg0: index):
    %0 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<10xi32>
    "affine.for"() ({
    ^bb0(%arg1: index):
      %1 = "affine.apply"(%arg1, %arg0) {map = #map20} : (index, index) -> index
      %2 = "affine.load"(%0, %1) {map = #map4} : (memref<10xi32>, index) -> i32
      "affine.yield"() : () -> ()
    }) {lower_bound = #map7, step = 1 : index, upper_bound = #map6} : () -> ()
    "func.return"() : () -> ()
  }) {function_type = (index) -> (), sym_name = "test_semi_affine_bailout"} : () -> ()
  "func.func"() ({
    %0 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<2x2xi32>
    "affine.for"() ({
    ^bb0(%arg0: index):
      %1 = "affine.apply"(%arg0) {map = #map21} : (index) -> index
      %2 = "affine.apply"(%arg0) {map = #map22} : (index) -> index
      %3 = "affine.load"(%0, %1, %2) {map = #map2} : (memref<2x2xi32>, index, index) -> i32
      "affine.yield"() : () -> ()
  ...
  "func.func"() ({
    %0 = "arith.constant"() {value = 0 : index} : () -> index
    %1 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<2x2x3x3x16x1xi32>
  ...
  "func.func"() ({
    %0 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<1xi32>
    %1 = "arith.constant"() {value = 9 : i32} : () -> i32
    "affine.for"() ({
    ^bb0(%arg0: index):
      %2 = "affine.apply"(%arg0) {map = #map33} : (index) -> index
      "affine.store"(%1, %0, %2) {map = #map4} : (i32, memref<1xi32>, index) -> ()
      "affine.yield"() : () -> ()
...
"builtin.module"() ({
  ...
  ^bb0(%arg0: memref<4x4x16x1xf32>):
    %0 = "arith.constant"() {value = 0 : index} : () -> index
    %1 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<1x2x3x3x16x1xf32>
    "affine.for"() ({
    ^bb0(%arg1: index):
      "affine.for"() ({
      ^bb0(%arg2: index):
...
"builtin.module"() ({
  "func.func"() ({
    %0 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<7xf32>
    %1 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<6xf32>
    "affine.for"() ({
    ^bb0(%arg0: index):
      "affine.for"(%arg0, %arg0) ({
      ^bb0(%arg1: index):
        %2 = "affine.load"(%0, %arg1) {map = #map0} : (memref<7xf32>, index) -> f32
        %3 = "affine.load"(%1, %arg1) {map = #map0} : (memref<6xf32>, index) -> f32
        "affine.yield"() : () -> ()
...
"builtin.module"() ({
  "func.func"() ({
    %0 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<1027xf32>
    %1 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<1026xf32>
    %2 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<4096xf32>
    %3 = "arith.constant"() {value = 2048 : index} : () -> index
    "affine.for"() ({
    ^bb0(%arg0: index):
      "affine.for"(%arg0, %arg0) ({
      ^bb0(%arg1: index):
        %4 = "affine.load"(%0, %arg1) {map = #map0} : (memref<1027xf32>, index) -> f32
        %5 = "affine.load"(%1, %arg1) {map = #map0} : (memref<1026xf32>, index) -> f32
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : (index, index) -> ()
      "affine.for"(%3) ({
      ^bb0(%arg1: index):
        %4 = "affine.load"(%2, %arg1) {map = #map0} : (memref<4096xf32>, index) -> f32
        "affine.yield"() : () -> ()
...
"builtin.module"() ({
  ...
  ^bb0(%arg0: memref<1024xf32>):
    ...
    ^bb0(%arg1: index):
      ...
      "affine.for"(%0, %0) ({
      ^bb0(%arg2: index):
        %1 = "affine.load"(%arg0, %arg2) {map = #map1} : (memref<1024xf32>, index) -> f32
        "affine.yield"() : () -> ()
      }) {lower_bound = #map1, step = 1 : index, upper_bound = #map2} : (index, index) -> ()
      "affine.yield"() : () -> ()
    }) {lower_bound = #map3, step = 4 : index, upper_bound = #map4} : () -> ()
    "func.return"() : () -> ()
  }) {function_type = (memref<1024xf32>) -> (), sym_name = "non_composed_bound_operand"} : () -> ()
  "func.func"() ({
