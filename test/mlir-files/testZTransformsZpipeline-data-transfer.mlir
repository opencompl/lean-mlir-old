...
"builtin.module"() ({
  "func.func"() ({
  ^bb0(%arg0: memref<512x32xvector<8 × f32>>, %arg1: memref<512x32xvector<8 × f32>>, %arg2: memref<512x32xvector<8 × f32>>):
    %0 = "arith.constant"() {value = 256 : index} : () -> index
    %1 = "arith.constant"() {value = 0 : index} : () -> index
    %2 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<64x4xvector<8 × f32>, 2>
    %3 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<64x4xvector<8 × f32>, 2>
    %4 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<64x4xvector<8 × f32>, 2>
    ...
    ^bb0(%arg3: index):
      ...
      "affine.dma_start"(%arg2, %8, %1, %4, %1, %7, %1, %0) {dst_map = #map1, src_map = #map2, tag_map = #map3} : (memref<512x32xvector<8 × f32>>, index, index, memref<64x4xvector<8 × f32>, 2>, index, memref<2 × i32>, index, index) -> ()
      ...
      ^bb0(%arg4: index):
        ...
        "affine.dma_start"(%arg0, %9, %1, %2, %1, %5, %1, %0) {dst_map = #map1, src_map = #map2, tag_map = #map3} : (memref<512x32xvector<8 × f32>>, index, index, memref<64x4xvector<8 × f32>, 2>, index, memref<2 × i32>, index, index) -> ()
        "affine.dma_start"(%arg1, %10, %1, %3, %1, %6, %1, %0) {dst_map = #map1, src_map = #map2, tag_map = #map3} : (memref<512x32xvector<8 × f32>>, index, index, memref<64x4xvector<8 × f32>, 2>, index, memref<2 × i32>, index, index) -> ()
    ...
    "memref.dealloc"(%4) : (memref<64x4xvector<8 × f32>, 2>) -> ()
    "memref.dealloc"(%3) : (memref<64x4xvector<8 × f32>, 2>) -> ()
    "memref.dealloc"(%2) : (memref<64x4xvector<8 × f32>, 2>) -> ()
    "func.return"() : () -> ()
  }) {function_type = (memref<512x32xvector<8 × f32>>, memref<512x32xvector<8 × f32>>, memref<512x32xvector<8 × f32>>) -> (), sym_name = "loop_dma_nested"} : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() ({
  ^bb0(%arg0: memref<512x32xvector<8 × f32>>):
    %0 = "arith.constant"() {value = 256 : index} : () -> index
    %1 = "arith.constant"() {value = 0 : index} : () -> index
    %2 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<64x4xvector<8 × f32>, 2>
    %3 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<64x4xvector<8 × f32>, 2>
    ...
    ^bb0(%arg1: index):
      ...
      "affine.dma_start"(%arg0, %8, %1, %4, %1, %7, %1, %0) {dst_map = #map1, src_map = #map2, tag_map = #map3} : (memref<512x32xvector<8 × f32>>, index, index, memref<64x4xvector<8 × f32>, 2>, index, memref<2 × i32>, index, index) -> ()
      "affine.dma_wait"(%7, %1, %0) {tag_map = #map3} : (memref<2 × i32>, index, index) -> ()
      "affine.dma_start"(%4, %1, %arg0, %8, %1, %7, %1, %0) {dst_map = #map2, src_map = #map1, tag_map = #map3} : (memref<64x4xvector<8 × f32>, 2>, index, memref<512x32xvector<8 × f32>>, index, index, memref<2 × i32>, index, index) -> ()
      "affine.dma_wait"(%7, %1, %0) {tag_map = #map3} : (memref<2 × i32>, index, index) -> ()
      "affine.yield"() : () -> ()
    ...
    "memref.dealloc"(%2) : (memref<64x4xvector<8 × f32>, 2>) -> ()
    "func.return"() : () -> ()
  }) {function_type = (memref<512x32xvector<8 × f32>>) -> (), sym_name = "loop_dma_dependent"} : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  ...
  ^bb0(%arg0: memref<512x32xf32>):
    ...
    %3 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<32x32xf32, 2>
    %4 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2 × i32>} : () -> memref<1 × i32>
    "affine.for"() ({
    ^bb0(%arg1: index):
      "affine.dma_start"(%arg0, %2, %3, %2, %4, %2, %1) {dst_map = #map0, src_map = #map0, tag_map = #map1} : (memref<512x32xf32>, index, memref<32x32xf32, 2>, index, memref<1 × i32>, index, index) -> ()
...
"builtin.module"() ({
  ...
  ^bb0(%arg0: memref<512x32xf32>, %arg1: memref<?x?xf32, 2>):
    ...
    "affine.for"() ({
    ^bb0(%arg2: index):
      "affine.dma_start"(%arg0, %1, %arg1, %1, %2, %1, %0) {dst_map = #map0, src_map = #map0, tag_map = #map1} : (memref<512x32xf32>, index, memref<?x?xf32, 2>, index, memref<1 × i32>, index, index) -> ()
