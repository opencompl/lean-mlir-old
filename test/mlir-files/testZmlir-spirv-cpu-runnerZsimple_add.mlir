"builtin.module"() ({
  "gpu.module"() ({
    "gpu.func"() ({
    ^bb0(%arg0: memref<3xf32>, %arg1: memref<3x3xf32>, %arg2: memref<3x3x3xf32>):
      %0 = "arith.constant"() {value = 0 : index} : () -> index
      %1 = "arith.constant"() {value = 1 : index} : () -> index
      %2 = "arith.constant"() {value = 2 : index} : () -> index
      %3 = "memref.load"(%arg0, %0) : (memref<3xf32>, index) -> f32
      ...
      "gpu.return"() : () -> ()
    }) {function_type = (memref<3xf32>, memref<3x3xf32>, memref<3x3x3xf32>) -> (), gpu.kernel, spv.entry_point_abi = {local_size = dense<1> : vector<3xi32>}, sym_name = "sum", workgroup_attributions = 0 : i64} : () -> ()
    "gpu.module_end"() : () -> ()
  }) {sym_name = "kernels"} : () -> ()
  "func.func"() ({
    ...
    %2 = "memref.alloc"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> memref<3x3x3xf32>
    ...
    %6 = "memref.cast"(%0) : (memref<3xf32>) -> memref<?xf32>
    %7 = "memref.cast"(%1) : (memref<3x3xf32>) -> memref<?x?xf32>
    %8 = "memref.cast"(%2) : (memref<3x3x3xf32>) -> memref<?x?x?xf32>
    "func.call"(%6, %4) {callee = @fillF32Buffer1D} : (memref<?xf32>, f32) -> ()
    ...
    "gpu.launch_func"(%9, %9, %9, %9, %9, %9, %0, %1, %2) {kernel = @kernels::@sum, operand_segment_sizes = dense<[0, 1, 1, 1, 1, 1, 1, 0, 3]> : vector<9xi32>} : (index, index, index, index, index, index, memref<3xf32>, memref<3x3xf32>, memref<3x3x3xf32>) -> ()
    %10 = "memref.cast"(%2) : (memref<3x3x3xf32>) -> memref<*xf32>
    "func.call"(%10) {callee = @print_memref_f32} : (memref<*xf32>) -> ()
    "func.return"() : () -> ()
  }) {function_type = () -> (), sym_name = "main"} : () -> ()
  "func.func"() ({
  }) {function_type = (memref<?xf32>, f32) -> (), sym_name = "fillF32Buffer1D", sym_visibility = "private"} : () -> ()
  "func.func"() ({
...
}) {gpu.container_module, spv.target_env = #spv.target_env<#spv.vce<v1.0, [Shader], [SPV_KHR_storage_buffer_storage_class, SPV_KHR_8bit_storage]>, {max_compute_workgroup_invocations = 128 : i32, max_compute_workgroup_size = dense<[128, 128, 64]> : vector<3xi32>}>} : () -> ()
