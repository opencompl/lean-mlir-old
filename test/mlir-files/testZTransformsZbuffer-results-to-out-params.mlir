"builtin.module"() ({
  ...
  }) {function_type = (memref<1xf32>) -> memref<2xf32>, sym_name = "presence_of_existing_arguments"} : () -> ()
  "func.func"() ({
    %0:2 = "test.source"() : () -> (memref<1xf32>, memref<2xf32>)
    "func.return"(%0#0, %0#1) : (memref<1xf32>, memref<2xf32>) -> ()
  }) {function_type = () -> (memref<1xf32>, memref<2xf32>), sym_name = "multiple_results"} : () -> ()
  "func.func"() ({
  ...
  "func.func"() ({
  }) {function_type = () -> (memref<1xf32>, memref<2xf32>, memref<3xf32>), res_attrs = [{}, {test.some_attr}, {}], sym_name = "mixed_result_attrs", sym_visibility = "private"} : () -> ()
}) : () -> ()

// -----
"builtin.module"() ({
  "func.func"() ({
  }) {function_type = () -> memref<1xf32>, sym_name = "callee", sym_visibility = "private"} : () -> ()
  "func.func"() ({
...
"builtin.module"() ({
  "func.func"() ({
  }) {function_type = () -> (memref<1xf32>, memref<2xf32>), sym_name = "callee", sym_visibility = "private"} : () -> ()
  "func.func"() ({
...
"builtin.module"() ({
  "func.func"() ({
  }) {function_type = () -> (i1, memref<1xf32>, i32), sym_name = "callee", sym_visibility = "private"} : () -> ()
  "func.func"() ({
...
"builtin.module"() ({
  "func.func"() ({
  }) {function_type = () -> memref<?xf32>, sym_name = "callee", sym_visibility = "private"} : () -> ()
  "func.func"() ({
